...
sub-application (e.g. `apps/extensions/openclaw/skills/<your-skill>/`, or any
`apps/extensions/<app>/skills/<your-skill>/` / `packages/claw-skills/`).
...
1. Rename the folder from `tnf-scaffold` to your skill name (lowercase, hyphens,
   ...
   (consumer views: `apps/extensions/openclaw/skills/`).
...
# rename to a real skill (canonical tree)

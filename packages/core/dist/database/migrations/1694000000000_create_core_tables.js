...
export class CreateCoreTables1694000000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createForeignKey('pipelines', new TableForeignKey({
            columnNames: ['owner_id'],
            referencedTableName: 'users',
            referencedColumnNames: ['id'],
            onDelete: 'CASCADE',
        ...
        await queryRunner.createIndex('pipeline_stages', new TableIndex({
...
//# sourceMappingURL=1694000000000_create_core_tables.js.map
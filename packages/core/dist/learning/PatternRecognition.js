...
var PatternRecognition_1;
import { Injectable, Logger } from '@nestjs/common';
import { EventEmitter2 } from '@nestjs/event-emitter';
let PatternRecognition = PatternRecognition_1 = class PatternRecognition {
    constructor(eventEmitter) {
        this.eventEmitter = eventEmitter;
        this.logger = new Logger(PatternRecognition_1.name);
    }
    recognize(data) {
...
PatternRecognition = PatternRecognition_1 = __decorate([
    Injectable(),

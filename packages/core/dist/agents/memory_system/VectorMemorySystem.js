 ...
 */
export class VectorMemorySystemImpl {
    /**
    ...
    async search(query, options) {
        ...
        const filteredResults = mockResults.filter((result) => result.relevance >= options.minRelevance);
        return Promise.resolve(filteredResults);
    }
}
//# sourceMappingURL=VectorMemorySystem.js.map
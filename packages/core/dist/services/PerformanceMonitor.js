...
let PerformanceMonitor = class PerformanceMonitor {
    ...
    async start() {
        ...
        try {
            ...
            logger.error('Failed to start PerformanceMonitor', error);
            throw error;
        }
    }
    async stop() {
        ...
        try {
            ...
            this.state = ServiceState.ERROR;
            logger.error('Failed to stop PerformanceMonitor', error);
            throw error;
        }
    }
    getState() {
...
PerformanceMonitor = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [MetricsCollector,
        SystemMonitor])
], PerformanceMonitor);

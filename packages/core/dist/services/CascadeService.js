...
let CascadeService = CascadeService_1 = class CascadeService extends EventEmitter {
    constructor() {
        super();
        this.logger = new Logger(CascadeService_1.name);
...
CascadeService = CascadeService_1 = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [])
], CascadeService);
export { CascadeService };

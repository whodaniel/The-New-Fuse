...
let ServiceCategoryRouterService = ServiceCategoryRouterService_1 = class ServiceCategoryRouterService {
    constructor(eventEmitter) {
        ...
        this.logger = new Logger(ServiceCategoryRouterService_1.name);
    }
    async routeServiceRequest(categoryId, request) {
        this.logger.log(`Routing service request for category ${categoryId}: ${JSON.stringify(request)}`);
...
//# sourceMappingURL=service-category-router.service.js.map
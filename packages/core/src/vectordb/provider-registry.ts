...
class PineconeProvider implements VectorStoreProvider {
  ...
  async storeVectors(): Promise<string[]> { throw new Error('Not implemented'); }
  async search(): Promise<any[]> { throw new Error('Not implemented'); }
  async deleteVectors(): Promise<boolean> { throw new Error('Not implemented'); }
  async clearNamespace(): Promise<boolean> { throw new Error('Not implemented'); }
}

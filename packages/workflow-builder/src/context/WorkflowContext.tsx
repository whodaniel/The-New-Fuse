...
export const WorkflowProvider: React.FC<WorkflowProviderProps> = ({
  ...
  // Persistence comes from the host, not from a REST client constructed here.
  const { workflowApi } = useWorkflowHost();
  ...
  const saveWorkflow = useCallback(async () => {
    try {
      ...
      const response = await workflowApi.saveWorkflow(workflowData);
      const responseError =

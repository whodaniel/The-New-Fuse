// @ts-nocheck
import { Input, Label, Textarea } from '@the-new-fuse/ui-consolidated';
import React, { memo, useEffect, useState } from 'react';
import { NodeProps } from 'reactflow';
import { useWorkflowHost } from '../host/context.js';
import type { MCPServer, MCPTool } from '../host/types.js';
import {
  Select,
  SelectContent,
  SelectItem,
...
const MCPToolNode: React.FC<NodeProps> = memo(({ id, data }) => {
  const { servers, loading, source, setSource, resetSource } = useWorkflowHost().useMcpTools();

...
import { A2AConfig, A2AMessage, A2APriority, AgentHeartbeat, AgentRegistration, AgentStatus, IA2ACommunicator } from './types.js';
export declare class A2ARedisAdapter extends EventEmitter implements IA2ACommunicator, OnModuleInit, OnModuleDestroy {

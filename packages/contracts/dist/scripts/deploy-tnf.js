...
async function main() {
    ...
    const AgencyReg = await hardhat_1.ethers.deployContract("FuseAgencyRegistry");
    ...
    const SFT = await hardhat_1.ethers.deployContract("AgentSponsorshipSFT", [UD_REGISTRY]);
    ...
    const Router = await hardhat_1.ethers.deployContract("FuseRevenueRouter", [
    ...
    const Auction = await hardhat_1.ethers.deployContract("FuseAuctionManager");
    ...
    const Badges = await hardhat_1.ethers.deployContract("FuseBadges");

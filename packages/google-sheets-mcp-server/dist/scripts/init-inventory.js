...
async function main() {
    ...
    try {
        ...
        if (!spreadsheetId) {
            ...
            // @ts-ignore
            const sheet = await (0, tools_js_1.createSpreadsheet)(SHEET_NAME, folderId);
        ...
        if (!existingId) {
            ...
            await (0, tools_js_1.shareSpreadsheet)(spreadsheetId, EMAIL, 'writer');
        ...
        await (0, tools_js_1.writeSheet)(spreadsheetId, 'Sheet1!A1:G1', HEADERS);

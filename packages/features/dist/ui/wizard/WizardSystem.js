...
exports.WizardBuilder = exports.WizardStateManager = void 0;
/**
...
class WizardStateManager {
     ...
     */
    registerWizard(definition) {
        this.definitions.set(definition.id, definition);
    }
    /**
     * Start a new wizard session
     */
    startWizard(wizardId, userId, userRole, initialData) {
     ...
     * Get current step
     */
    getCurrentStep(userId, wizardId) {
     ...
     */
    async validateCurrentStep(userId, wizardId) {
        const progress = this.getProgress(userId, wizardId);
        if (!progress) {
     ...
     */
    updateContext(userId, wizardId, data) {
        const progress = this.getProgress(userId, wizardId);
        if (!progress) {
            throw new Error('No wizard progress found');
        }
     ...
     */
    calculateCompletionPercentage(progress, definition) {
     ...
     */
    getAvailableWizards(userRole, skillLevel) {
        return Array.from(this.definitions.values()).filter((def) => def.targetAudience.includes(skillLevel) || def.targetAudience.includes('all'));
    }
    /**
     * Get wizard suggestions based on user context
     */
    getSuggestedWizards(userRole, userGoals, completedWizards) {
...
exports.WizardStateManager = WizardStateManager;
/**
 * Wizard Factory
...
//# sourceMappingURL=WizardSystem.js.map
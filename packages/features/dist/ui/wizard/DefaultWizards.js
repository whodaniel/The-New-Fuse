...
exports.DEFAULT_WIZARDS = void 0;
exports.createGetStartedWizard = createGetStartedWizard;
exports.createAgentCreationWizard = createAgentCreationWizard;
exports.createDeployToCloudRuntimeWizard = createDeployToCloudRuntimeWizard;
exports.createConfigureRBACWizard = createConfigureRBACWizard;
exports.createTroubleshootingWizard = createTroubleshootingWizard;
const WizardSystem_js_1 = require("./WizardSystem.js");
/**
 * Get Started Wizard - First-time user onboarding
 */
function createGetStartedWizard() {
    return new WizardSystem_js_1.WizardBuilder('get-started', 'Get Started with The New Fuse')
 ...
 */
function createAgentCreationWizard() {
    return new WizardSystem_js_1.WizardBuilder('create-agent', 'Create an AI Agent')
 ...
 */
function createDeployToCloudRuntimeWizard() {
    return new WizardSystem_js_1.WizardBuilder('deploy-cloud_runtime', 'Deploy to CloudRuntime')
 ...
 */
function createConfigureRBACWizard() {
    return new WizardSystem_js_1.WizardBuilder('configure-rbac', 'Configure Role-Based Access Control')
 ...
 */
function createTroubleshootingWizard() {
    return new WizardSystem_js_1.WizardBuilder('troubleshooting', 'Troubleshoot Issues')
        ...
        estimatedTime: 60,
        nextStep: ((context) => {
            const issueType = context.data.issueType;
            switch (issueType) {
                case 'authentication':
...
//# sourceMappingURL=DefaultWizards.js.map
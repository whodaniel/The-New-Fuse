...
DATABASE_URL="postgresql://user:password@localhost:5432/thenewfuse"`,
  ...
  },
  {
    ...
    title: 'Fix Cloud Run Deployment',
    description:
      'Steps to resolve GCP Cloud Run deployment issues (legacy CloudRuntime CLI is retired)',
    forIssues: [
      'deployment',
      'Deploy to CloudRuntime',
      'CloudRuntime deployment failing',
      'Cloud Run',
    ],
    steps: [
      {
      ...
      },
      {
        ...
        content: 'gcloud run services list --project=the-new-fuse-2025 --region=us-central1',
      },
      {
        id: '3',
        type: 'command',
        ...
        content:
          'gcloud run services logs read SERVICE --project=the-new-fuse-2025 --region=us-central1',
      },
      {
        id: '4',
        type: 'manual',
        title: 'Check environment variables',
        content: 'Verify required env vars in Cloud Run console (or gcloud run services describe)',
      },
      {
        id: '5',
        type: 'command',
        title: 'Force redeploy',
        content: 'bash scripts/deployment/gcp-deploy.sh',
      },
    ],

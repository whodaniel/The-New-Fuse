...
export type WorkflowCategory = 'data-processing' | 'api-integrations' | 'automation' | 'ai-agents' | 'database-operations' | 'file-management' | 'notifications' | 'webhooks' | 'crm' | 'email' | 'social-media' | 'analytics' | 'DevOps' | 'security' | 'other';
export type WorkflowSource = 'Zie619/n8n-workflows' | 'enescingoz/awesome-n8n-templates' | 'Danitilahun/n8n-workflow-templates' | 'custom';

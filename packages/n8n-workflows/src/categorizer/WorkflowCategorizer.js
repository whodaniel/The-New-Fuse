...
exports.WorkflowCategorizer = void 0;
class WorkflowCategorizer {
    ...
    categorize(workflow) {
        ...
        const text = `${workflow.name} ${workflow.description} ${workflow.tags.join(' ')}`.toLowerCase();
        this.categoryConfigs.forEach((config) => {
     ...
     */
    suggestCategories(workflow, topN = 3) {
        const scores = new Map();
...
exports.WorkflowCategorizer = WorkflowCategorizer;
//# sourceMappingURL=WorkflowCategorizer.js.map
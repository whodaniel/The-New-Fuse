...
import type { CollectionConfig, EmbeddingConfig, VectorDatabaseConfig, VectorDocument, VectorQuery, VectorSearchResult } from './interface/vector-database.interface.js';

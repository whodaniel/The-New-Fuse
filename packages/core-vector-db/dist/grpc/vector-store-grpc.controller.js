...
let VectorStoreGrpcController = VectorStoreGrpcController_1 = class VectorStoreGrpcController {
    constructor(vectorService) {
        ...
        this.logger = new Logger(VectorStoreGrpcController_1.name);
    }
    ...
    async upsertDocuments(request, _metadata, _call) {
        try {
            ...
            if (request.generateEmbeddings) {
                documents = await Promise.all(request.documents.map(async (doc) => {
    ...
    async getDocument(request, _metadata, _call) {
        try {
    ...
    async getStats(request, _metadata, _call) {
        try {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Function, Object]),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "upsertDocuments", null);
__decorate([
    GrpcMethod('VectorStoreService', 'GetDocument'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Function, Object]),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "getDocument", null);
__decorate([
    GrpcMethod('VectorStoreService', 'SimilaritySearch'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Function, Object]),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "similaritySearch", null);
__decorate([
    GrpcMethod('VectorStoreService', 'HealthCheck'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "healthCheck", null);
__decorate([
    GrpcMethod('VectorStoreService', 'GetStats'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Function, Object]),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "getStats", null);
__decorate([
    GrpcMethod('VectorStoreService', 'ListCollections'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "listCollections", null);
__decorate([
    GrpcMethod('VectorStoreService', 'DeleteCollection'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], VectorStoreGrpcController.prototype, "deleteCollection", null);
VectorStoreGrpcController = VectorStoreGrpcController_1 = __decorate([
    Controller(),
    GrpcService(),
    __metadata("design:paramtypes", [VectorDatabaseService])
], VectorStoreGrpcController);
export { VectorStoreGrpcController };

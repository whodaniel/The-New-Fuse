...
export class LegacyVectorAdapter {
    ...
    async search(queryEmbedding, options) {
        ...
        return results.map((result) => ({
            ...
            embedding: options.includeVectors && 'embedding' in result ? result.embedding : undefined,
        }));
    }
    /**
 ...
 */
export function createLegacyAdapter(vectorService, defaultCollection = 'default') {

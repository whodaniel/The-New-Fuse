...
const FeatureTrackingExample = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "max-w-4xl mx-auto p-4", children: [(0, jsx_runtime_1.jsx)(FeatureProgress_1.FeatureProgress, { feature: feature }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-8 space-y-4", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "font-semibold mb-2", children: "Update Stage" }), (0, jsx_runtime_1.jsx)("select", { className: "border rounded p-2", value: feature.currentStage, onChange: (e) => handleStageUpdate(e.target.value), "aria-label": "Select feature stage", children: Object.values(types_1.FeatureStage).map((stage) => ((0, jsx_runtime_1.jsx)("option", { value: stage, children: stage }, stage))) })] }), (0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("h3", { className: "font-semibold mb-2", children: "Actions" }), (0, jsx_runtime_1.jsxs)("div", { className: "space-x-4", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", className: "bg-blue-500 text-white px-4 py-2 rounded", onClick: handleMetricsUpdate, children: "Update Metrics" }), (0, jsx_runtime_1.jsx)("button", { type: "button", className: "bg-green-500 text-white px-4 py-2 rounded", onClick: handleAssessmentUpdate, children: "Update Assessment" })] })] })] })] }));
};

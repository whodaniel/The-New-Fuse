...
exports.MapReducePattern = void 0;
const events_1 = require("events");
/**
 * Map-Reduce pattern for distributed data processing
 */
class MapReducePattern extends events_1.EventEmitter {
     ...
     */
    async execute(input, mapFn, reduceFn, options = {}) {
     ...
     * Create map tasks
     */
    async createMapTasks(input, mapFn, concurrency) {
        const tasks = [];
     ...
     */
    async waitForMapResults(tasks, timeout) {
        const results = [];
...
exports.MapReducePattern = MapReducePattern;
//# sourceMappingURL=MapReducePattern.js.map
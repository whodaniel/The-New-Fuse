        ...
        children: [
          _jsxs('div', {
            ...
            children: [
              ...
              _jsx(Badge, { className: statusColor, children: agent.status }),
            ],
          }),
          !compact &&
            _jsxs('div', {
              ...
              children: [
                ...
                _jsxs('p', {
                  ...
                  children: ['Type: ', agent.type],
                }),
                agent.role &&
                  _jsxs('p', {
                    className: 'text-xs text-gray-400',
                    children: ['Role: ', agent.role],
                  }),
              ],
            }),
        ],
          ...
          showProtocols &&
            ...
            _jsxs('div', {
              children: [
                ...
                _jsx('div', {
                  className: 'mt-1 flex flex-wrap gap-1',
                  children: agent.protocols.map((protocol) =>
                    _jsx(
                      Badge,
                      {
                  ...
                  children: [
                    agent.endpoints.discovery &&
                      _jsxs('div', {
                        ...
                        children: [
                          _jsx('span', { className: 'font-medium mr-1', children: 'Discovery:' }),
                          _jsx('span', {
                            className: 'truncate',
                            children: agent.endpoints.discovery,
                          }),
                          _jsx(ExternalLink, {
                    ...
                    agent.endpoints.messaging &&
                      _jsxs('div', {
                        className: 'flex items-center',
                        children: [
                          _jsx('span', { className: 'font-medium mr-1', children: 'Messaging:' }),
                          _jsx('span', {
                            className: 'truncate',
                            children: agent.endpoints.messaging,
                          }),
                        ],
                      }),
                  ],
            ...
            _jsxs('div', {
              children: [
                ...
                _jsxs('div', {
                  ...
                  children: [
                    _jsxs('div', {
                      children: ['Authentication: ', agent.security.authentication || 'none'],
                    }),
                    _jsxs('div', {
                      children: [
                        'Encryption: ',
                        agent.security.encryption ? 'Enabled' : 'Disabled',
                      ],
                    }),
                    agent.security.rateLimit &&
                      _jsxs('div', {
                        children: ['Rate Limit: ', agent.security.rateLimit, ' req/min'],
                      }),
                  ],
                }),
              ],
            ...
            _jsxs('div', {
              ...
              children: [
                agent.metadata.version &&
                  _jsxs('span', { children: ['Version: ', agent.metadata.version] }),
                agent.metadata.lastActive &&
                  _jsxs('span', {
                    children: [
                      'Last active: ',
                      new Date(agent.metadata.lastActive).toLocaleString(),
                    ],
                  }),
              ],
            }),
        ...
        children: [
          ...
          isActive &&
            ...
            _jsx(Button, {
              ...
              icon: _jsx(PauseCircle, { className: 'h-4 w-4' }),
              children: 'Stop',
            }),
          !isActive &&
            onStart &&
            _jsx(Button, {
              ...
              icon: _jsx(PlayCircle, { className: 'h-4 w-4' }),
              children: 'Start',
            }),
          onEdit &&
            _jsx(Button, {

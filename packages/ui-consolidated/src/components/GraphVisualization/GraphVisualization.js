      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsx(Cpu, { className: 'w-4 h-4 text-blue-400' }),
          }),
          _jsx('span', { children: data.label }),
        ],
      }),
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', { children: data.status || 'idle' }),
        ],
      }),
      data.metadata &&
        _jsx('div', {
          className: styles.metadataList,
          children: Object.entries(data.metadata).map(([key, value]) =>
            _jsxs(
              'div',
              {
                className: styles.metadataItem,
                children: [
                  _jsxs('span', { className: 'opacity-60', children: [key, ':'] }),
                  _jsx('span', { className: styles.metadataValue, children: value }),
                ],
              },
              key
            )
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            className: 'p-1.5 rounded-md bg-sky-500/10 border border-sky-500/20',
            children: _jsx(Shield, { className: 'w-4 h-4 text-sky-300' }),
          }),
          _jsx('span', { children: data.label }),
        ],
      }),
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('span', { children: data.status || 'queued' }),
        ],
      }),
      data.metadata &&
        _jsx('div', {
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            ...
            children: _jsx(Brain, { className: 'w-4 h-4 text-purple-300' }),
          }),
          _jsx('span', { children: data.label }),
        ],
      }),
      _jsxs('div', {
        ...
        children: [
          _jsx('div', {
            className: `${styles.statusIndicator} ${data.status === 'running' ? styles.statusRunning : styles.statusIdle}`,
          }),
          _jsx('span', { children: data.status || 'standby' }),
        ],
      }),
    ],
  });
...
export function GraphVisualization({
  ...
  if (loading) {
    return _jsx('div', {
      ...
      children: _jsx('div', { className: styles.loadingSpinner }),
    });
  }
  if (error) {
    return _jsxs('div', {
  ...
  return _jsx('div', {
    ...
    children: _jsxs(ReactFlow, {
      ...
      children: [
        _jsx(Background, { color: darkMode ? '#333333' : '#aaaaaa', gap: 16 }),
        showControls && _jsx(Controls, {}),
        showMiniMap &&
          _jsx(MiniMap, {
            nodeColor: (n) => {
              const data = n.data;
        ...
        _jsxs(Panel, {
          ...
          children: [
            _jsxs('select', {
              ...
              children: [
                _jsx('option', { value: 'dagre', children: 'Hierarchical' }),
                _jsx('option', { value: 'force', children: 'Force-Directed' }),
                _jsx('option', { value: 'layered', children: 'Layered' }),
              ],
            }),
            _jsxs('select', {
              className: styles.layoutSelect,
              onChange: (e) =>
                filterGraph({ types: e.target.value ? [e.target.value] : undefined }),
              defaultValue: '',
              'aria-label': 'Filter by node type',
              children: [
                _jsx('option', { value: '', children: 'All Types' }),
                _jsx('option', { value: 'task', children: 'Tasks' }),
                _jsx('option', { value: 'agent', children: 'Agents' }),
                _jsx('option', { value: 'tool', children: 'Tools' }),
                _jsx('option', { value: 'message', children: 'Messages' }),
                _jsx('option', { value: 'data', children: 'Data' }),
                _jsx('option', { value: 'service', children: 'Services' }),
                _jsx('option', { value: 'event', children: 'Events' }),
                _jsx('option', { value: 'state', children: 'States' }),
              ],
            }),
          ],
        }),

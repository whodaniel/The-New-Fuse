...
export const ConversationExportDemo = () => {
  ...
  return _jsxs('div', {
    className: 'max-w-xl mx-auto p-4 bg-card rounded shadow',
    children: [
      _jsx('h2', { className: 'text-lg font-semibold mb-2', children: 'Conversation Export Demo' }),
      _jsx('textarea', {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx(ExportButton, {
            conversation: conversation,
            format: 'md',
            buttonLabel: 'Export as Markdown',
          }),
          _jsx(ExportButton, {
            conversation: conversation,
            format: 'txt',
            buttonLabel: 'Export as Text',
          }),
        ],
      }),
    ],

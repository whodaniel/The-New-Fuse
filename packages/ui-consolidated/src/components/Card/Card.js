...
const Header = forwardRef(({ className, ...props }, ref) =>
  _jsx('div', { ref: ref, className: cn('p-4', className), ...props })
);
Header.displayName = 'Card.Header';
const Title = forwardRef(({ className, ...props }, ref) =>
  _jsx('h3', { ref: ref, className: cn('text-lg font-semibold', className), ...props })
);
Title.displayName = 'Card.Title';
const Description = forwardRef(({ className, ...props }, ref) =>
  _jsx('p', { ref: ref, className: cn('text-sm text-muted-foreground', className), ...props })
);
Description.displayName = 'Card.Description';
const Content = forwardRef(({ className, ...props }, ref) =>
  _jsx('div', { ref: ref, className: cn('p-4 pt-0', className), ...props })
);
Content.displayName = 'Card.Content';
const Footer = forwardRef(({ className, ...props }, ref) =>
  _jsx('div', { ref: ref, className: cn('flex items-center p-4 pt-0', className), ...props })
);

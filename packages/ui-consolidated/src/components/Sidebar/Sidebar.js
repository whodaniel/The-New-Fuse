...
const Sidebar = React.forwardRef(
  (
    ...
    // Default header
    const defaultHeader = _jsxs('div', {
      className: 'h-16 flex items-center justify-between px-4 border-b',
      children: [
        !collapsed && _jsx('div', { className: 'text-xl font-semibold', children: 'The New Fuse' }),
        mobile &&
          _jsxs('button', {
            type: 'button',
            className:
          ...
          children: [
            ...
            items.length > 0 &&
              _jsx('nav', {
                ...
                children: items.map((item, _itemIdx) =>
                  _jsxs(
                    'a',
                    {
                      href: item.href,
                      ...
                      children: [
                        ...
                        !collapsed && _jsx('span', { children: item.label }),
                      ],
                    },
                    item.key || item.href
                  )
            ...
            footer && _jsx('div', { className: 'mt-auto p-4 border-t', children: footer }),
          ],
        }),
        mobile &&
          open &&

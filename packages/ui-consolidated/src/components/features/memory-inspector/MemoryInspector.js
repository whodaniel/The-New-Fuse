...
const MemoryInspector = ({ agentId }) => {
  ...
  if (loading) return _jsx('div', { children: 'Loading memory...' });
  if (error) return _jsxs('div', { children: ['Error: ', error] });
  return _jsxs(Card, {
    children: [
      _jsx(CardHeader, { children: _jsx(CardTitle, { children: 'Memory Inspector' }) }),
      _jsx(CardContent, {
              ...
              _jsxs(
                ListItem,
                {
                  ...
                  children: [
                    _jsxs('div', {
                      children: [
                        _jsx('p', { className: 'font-medium', children: item.content }),
                        _jsx('p', {
                    ...
                    _jsx(Badge, {
                      variant: item.type === 'core' ? 'default' : 'secondary',
                      children: item.type,
                    }),
                  ],
                },

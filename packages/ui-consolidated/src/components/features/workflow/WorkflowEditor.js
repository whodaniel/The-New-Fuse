    ...
    return _jsxs('div', {
      ...
      children: [
        _jsxs(Button, {
          ...
          variant: 'outline',
          size: 'sm',
          children: [_jsx(Edit, { className: 'h-4 w-4 mr-1' }), 'Edit'],
        }),
        _jsxs(Button, {
          onClick: onDelete,
          variant: 'outline',
          ...
          children: [_jsx(Trash2, { className: 'h-4 w-4 mr-1' }), 'Delete'],
        }),
      ],
    });
  };
      ...
      children: [
        _jsx(CardHeader, {
          children: _jsxs(CardTitle, {
            ...
            children: [
              _jsxs('span', { children: ['Workflow Editor: ', workflow.name] }),
              _jsxs('div', {
                ...
                children: [
                  _jsxs(Button, {
                    ...
                    variant: 'outline',
                    size: 'sm',
                    children: [_jsx(PlusCircle, { className: 'h-4 w-4 mr-1' }), 'Add Step'],
                  }),
                  _jsx(Button, {
        ...
        _jsxs(CardContent, {
          children: [
            _jsx(WorkflowVisualizer, { definition: workflow }),
            _jsxs(Dialog, {
              children: [
                _jsx(DialogTrigger, {
                  asChild: true,
                  children: _jsx('span', { className: 'hidden', children: 'Open Step Editor' }),
                }),
                editedStep &&
                  _jsxs(DialogContent, {
                    ...
                    children: [
                      _jsx(DialogHeader, {
                        children: _jsx(DialogTitle, {
                          children: isNewStep ? 'Add New Step' : 'Edit Step',
                        }),
                      }),
                      _jsxs('div', {
                        ...
                        children: [
                          ...
                          _jsx(Input, {
                            ...
                            onChange: (e) => handleStepChange('type', e.target.value),

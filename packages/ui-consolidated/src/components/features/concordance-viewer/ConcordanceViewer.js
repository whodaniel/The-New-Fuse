...
export const ConcordanceViewer = ({
  ...
  if (loading) return _jsx(Skeleton, {});
  if (error || !data)
    return _jsxs(Alert, {
      children: [
    ...
    children: [
      _jsx('div', {
        ...
        children: [
          ...
          _jsx(
            Card,
            {
              className: 'bg-slate-950/60 border-white/[0.08] backdrop-blur-xl',
        ...
        children: [
          _jsx(CardHeader, {
            children: _jsx(CardTitle, {
              ...
              children: 'Power Phrases & Communication Patterns',
            }),
          }),
          _jsx(CardContent, {
            children: _jsx('div', {
              className: 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3',
              children: powerPhraseData.map((group) =>
                _jsxs(
                  'div',
                  {
                    ...
                    children: [
                      _jsxs('h4', {
                        ...
                        children: [group.icon, ' ', group.title],
                      }),
                      _jsx('div', {
                        className: 'flex flex-wrap gap-1.5',
                        children: group.matches.map((w) =>
                          _jsxs(
                            'button',
                            {
                              onClick: () => setSelectedWord(w.word),
                              className:
                                'text-xs bg-white/[0.05] hover:bg-white/[0.1] border border-white/[0.08] rounded px-2 py-1 text-slate-300 transition-colors',
                              children: [
                                w.word,
                                ' ',
                                _jsxs('span', {
        ...
        children: [
          _jsx(CardHeader, {
            children: _jsxs('div', {
              ...
              children: [
                _jsx(CardTitle, { className: 'text-slate-100', children: 'Categories' }),
                selectedCategory &&
                  _jsx('button', {
          ...
          _jsx(CardContent, {
            children: _jsx('div', {
              ...
              children: Object.entries(data.categories).map(([name, cat]) =>
                _jsxs(
                  'button',
                  {
                    ...
                    children: [
                      ...
                      _jsxs('div', {
                        ...
                        children: [cat.count, ' identifiers'],
                      }),
                      _jsx('div', {
                        className: 'flex flex-wrap gap-1 mt-2',
                        children: cat.topWords
                          .slice(0, 3)
                          .map((w) =>
                            _jsx(
                              'span',
                              {
                                className:
                                  'text-[10px] text-slate-400 bg-white/[0.05] rounded px-1.5 py-0.5',
                                children: w.word,
                              },
                              w.word
                            )
        ...
        children: [
          _jsx(CardHeader, {
            children: _jsxs('div', {
              ...
              children: [
                _jsx(CardTitle, { className: 'text-slate-100', children: 'Word Explorer' }),
                _jsxs('div', {
                  ...
                  children: [
                    _jsx(Input, {
                      ...
                      className:
                        'w-56 bg-slate-900/50 border-white/10 text-slate-100 placeholder:text-slate-600',
                    }),
                    _jsx('div', {
                      className: 'flex gap-1',
                      children: ['cloud', 'list'].map((v) =>
                        _jsx(
                          'button',
                          {
                            onClick: () => setView(v),
                            className: `px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${view === v ? 'bg-blue-600 text-white' : 'bg-slate-800 text-slate-400 hover:text-slate-200'}`,
                            children: v === 'cloud' ? 'Cloud' : 'List',
                          },
                          v
                        )
                      ),
                    ...
                    _jsxs('select', {
                      ...
                      className:
                        'bg-slate-800 border border-white/10 text-slate-300 text-xs rounded-lg px-2 py-1.5',
                      children: [
                        _jsx('option', { value: 'count', children: 'By Frequency' }),
                        _jsx('option', { value: 'alpha', children: 'Alphabetical' }),
                        _jsx('option', { value: 'length', children: 'By Length' }),
                      ],
                    }),
                  ],
                }),
          ...
          _jsx(CardContent, {
            children:
              view === 'cloud'
                ? _jsx('div', {
                    className: 'flex flex-wrap gap-1.5',
                    children: filteredWords.slice(0, 200).map((w) => {
                      ...
                      return _jsxs(
                        'button',
                        {
                          onClick: () => setSelectedWord(w.word),
                          className:
                            'hover:bg-white/[0.08] rounded px-1.5 py-0.5 transition-colors',
                          style: { fontSize: `${scale}rem`, opacity },
                          children: [
                            _jsx('span', { className: 'text-slate-100', children: w.word }),
                            _jsxs('span', {
                ...
                : _jsx('div', {
                    ...
                    children: filteredWords.slice(0, 100).map((w) => {
                        ...
                        'div',
                        {
                          ...
                          children: [
                            _jsx('button', {
                              onClick: () => setSelectedWord(w.word),
                              className:
                                'w-28 text-right text-slate-300 hover:text-white truncate transition-colors',
                              children: w.word,
                            }),
                            _jsx('div', {
                              className: 'flex-1 h-5 bg-white/[0.03] rounded overflow-hidden',
                              children: _jsx('div', {
                                className:
                                  'h-full rounded bg-gradient-to-r from-blue-600 to-violet-600',
                                style: { width: `${barWidth}%` },
                              }),
                            }),
                            _jsx('span', {
                              className: 'text-xs text-slate-500 font-mono w-16 text-right',
                              children: w.count.toLocaleString(),
                            }),
                          ],
                        },
              ...
              _jsx(CardContent, {
                children: _jsx(ResponsiveContainer, {
                  ...
                  children: _jsxs(BarChart, {
                    data: freqChartData,
                    children: [
                      _jsx(CartesianGrid, { strokeDasharray: '3 3', stroke: '#1e293b' }),
                      _jsx(XAxis, { dataKey: 'name', tick: { fill: '#64748b', fontSize: 11 } }),
                      _jsx(YAxis, { tick: { fill: '#64748b', fontSize: 11 } }),
                      _jsx(Tooltip, {
                        contentStyle: {
                          background: '#0f172a',
                      ...
                      _jsx(Bar, { dataKey: 'value', fill: '#3b82f6', radius: [4, 4, 0, 0] }),
                    ],
                  }),
                }),
              }),
                ...
                children: _jsx(ResponsiveContainer, {
                  ...
                  children: _jsxs(BarChart, {
                    ...
                    children: [
                      ...
                      _jsx(Bar, { dataKey: 'value', fill: '#7c3aed', radius: [4, 4, 0, 0] }),
                    ],
                  }),
                }),
              }),
      ...
      _jsxs(Card, {
        ...
        children: [
          _jsx(CardHeader, {
            children: _jsx(CardTitle, {
              className: 'text-slate-100 text-sm',
              children: 'Top Files by Identifier Density',
            }),
          }),
          _jsx(CardContent, {
            children: _jsx('div', {
              className: 'max-h-64 overflow-y-auto space-y-1',
              children: data.topFiles.slice(0, 30).map((f) => {
                ...
                return _jsxs(
                  'div',
                  {
                    ...
                    children: [
                      ...
                      _jsx('div', {
                        className: 'flex-1 h-4 bg-white/[0.03] rounded overflow-hidden',
                        children: _jsx('div', {
      ...
      selectedWord &&
        _jsx('div', {
          ...
          children: _jsxs('div', {
            className:
              'bg-slate-950 border border-white/10 rounded-2xl p-6 max-w-lg w-full mx-4 shadow-2xl',
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsxs(Badge, {
                          ...
                          children: [wordData.count.toLocaleString(), ' occurrences'],
                        }),
                        _jsxs(Badge, {
                          className: 'bg-violet-600',
                          children: [wordData.files?.length ?? 0, ' files'],
                        }),
                      ],
                    }),
                    wordData.files &&
                      wordData.files.length > 0 &&
                      _jsxs('div', {
                        children: [
                          _jsx('p', {
                            className:
                            ...
                            children: wordData.files
                              ...
                              .map((f) =>
                                _jsxs(
                                  ...
                                  {
                                    className:
                                      'text-xs text-slate-400 font-mono bg-white/[0.03] rounded px-3 py-1.5',
                                    children: [
                                      f.file,
                                      f.lines &&
                                        f.lines.length > 0 &&
                                        _jsxs('span', {
                                          ...
                                          children: ['lines ', f.lines.slice(0, 5).join(', ')],
                                        }),
                                    ],
                                  },
                                  f.file

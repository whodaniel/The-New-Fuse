...
// Agent Tag Component
const AgentTag = ({ agent, onEdit, onDelete }) =>
  _jsxs('div', {
    className: 'flex items-center gap-2 bg-gray-200 dark:bg-gray-700 rounded-full pr-3 pl-1 py-1',
    children: [
      _jsx('img', {
        src: agent.profilePictureUrl || 'https://placehold.co/32x32/667eea/ffffff?text=A',
        alt: agent.name,
        className: 'w-8 h-8 rounded-full object-cover',
      }),
      _jsx('span', { className: 'font-medium text-sm', children: agent.name }),
      _jsx('button', {
        onClick: onEdit,
    ...
    children: [
      ...
      isSystem &&
        _jsx('div', {
          ...
          children: _jsx(SystemIcon, {}),
        }),
      _jsxs('div', {
        className: `p-4 rounded-xl shadow-md ${bubbleClass}`,
        children: [
          !isYou &&
            !isSystem &&
            _jsxs('div', {
              ...
              children: [
                _jsx('span', { className: 'font-bold', children: message.sender }),
                Icon && _jsx(Icon, {}),
              ],
            }),
          _jsx('p', { className: 'whitespace-pre-wrap break-words', children: message.text }),
        ],
      }),
    ],
  });
...
const AgentModal = ({ isOpen, agent, onClose, onSave }) => {
  ...
  return _jsx('div', {
    ...
    children: _jsxs('form', {
      ...
      className:
        'bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto',
      children: [
        _jsx('h2', {
          className: 'text-xl font-bold mb-4',
          children: agent ? 'Edit Agent' : 'Create Agent',
        }),
        _jsxs('div', {
          className: 'mb-4',
          children: [
            _jsx('label', { className: 'block mb-1 font-semibold', children: 'Name' }),
            _jsx('input', {
              type: 'text',
              value: name,
        ...
        _jsxs('div', {
          ...
          children: [
            _jsx('label', {
              ...
              children: 'System Prompt (Persona)',
            }),
            _jsx('textarea', {
              value: systemPrompt,
        ...
        _jsxs('div', {
          className: 'mb-4',
          children: [
            _jsx('label', { className: 'block mb-1 font-semibold', children: 'Profile Picture' }),
            _jsxs('div', {
              className: 'flex items-center gap-4',
              children: [
                _jsx('img', {
                  src: profilePictureUrl || 'https://placehold.co/80x80/1f2937/ffffff?text=...',
                  alt: 'Profile',
                ...
                _jsx('button', {
                  ...
                  className:
                    'px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:bg-indigo-400',
                  children: isGeneratingPic ? 'Generating...' : 'Generate New',
                }),
              ],
            }),
            picError && _jsx('p', { className: 'text-red-500 text-sm mt-2', children: picError }),
          ],
        }),
        _jsxs('div', {
          className: 'mb-4',
          children: [
            _jsx('label', { className: 'block mb-1 font-semibold', children: 'LLM Provider' }),
            _jsx('select', {
              value: llm,
              onChange: (e) => setLlm(e.target.value),
              className: 'w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600',
              children: Object.entries(providerDetails).map(([key, { name }]) =>
                _jsx('option', { value: key, children: name }, key)
              ),
            }),
          ],
        }),
        _jsxs('div', {
          className: 'mb-6',
          children: [
            _jsx('label', { className: 'block mb-1 font-semibold', children: 'Model Name' }),
            _jsx('input', {
              type: 'text',
              value: model,
...
const ScenarioModal = ({ isOpen, onClose, onSend }) => {
  ...
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      ...
      children: [
        _jsx('h2', { className: 'text-xl font-bold mb-4', children: 'Inject Scenario' }),
        _jsx('p', {
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsx('button', {
              ...
              disabled: !text.trim(),
              className:
                'px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 disabled:bg-red-400',
              children: 'Send Scenario',
            }),
          ],
        }),
      ],
...
const RulesModal = ({ isOpen, onClose }) => {
  ...
  return _jsx('div', {
    ...
    children: _jsxs('div', {
      className: 'bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-lg',
      children: [
        _jsx('h2', { className: 'text-xl font-bold mb-4', children: 'Conversation Rules' }),
        _jsx('p', {
          className: 'text-sm text-gray-600 dark:text-gray-400 mb-4',
        ...
        _jsxs('form', {
          ...
          children: [
            _jsx('select', {
              ...
              required: true,
              className: 'w-full p-2 border rounded dark:bg-gray-700 dark:border-gray-600',
              children: agents.map((a) => _jsx('option', { value: a.id, children: a.name }, a.id)),
            }),
        ...
        _jsxs('div', {
          ...
          children: [
            rules.map((rule) => {
              ...
              return _jsxs(
                'div',
                {
                  ...
                  children: [
                    _jsxs('span', {
                      children: [sourceAgent.name, ' \u27A1\uFE0F ', targetAgent.name],
                    }),
                    _jsx('button', {
            ...
            rules.length === 0 &&
              _jsx('p', { className: 'text-center text-gray-500', children: 'No rules defined.' }),
          ],
        }),
        _jsx('div', {
...
export const MultiAgentChat = ({
  ...
  if (isLoading) {
    return _jsx('div', {
      className:
        'flex h-screen w-full items-center justify-center bg-gray-100 dark:bg-gray-900 text-white',
      children: 'Loading Multi-Agent Chat...',
    });
  }
  return _jsxs('div', {
    ...
    children: [
      isAutomating &&
        _jsxs('div', {
          className:
            'fixed inset-0 bg-black bg-opacity-75 flex flex-col justify-center items-center z-50',
          children: [
            _jsx('div', {
              className:
                'w-16 h-16 border-8 border-dashed rounded-full animate-spin border-blue-500',
            }),
            _jsx('p', { className: 'text-white text-xl mt-4', children: 'Automating Setup...' }),
          ],
        }),
      _jsx(AgentModal, {
      ...
      _jsx(RulesModal, { isOpen: isRuleModalOpen, onClose: () => setIsRuleModalOpen(false) }),
      _jsx('header', {
        className: 'bg-white dark:bg-gray-800 shadow-sm p-3 z-10',
        children: _jsxs('div', {
          ...
          children: [
            ...
            _jsx('button', {
              ...
              className:
                'flex-shrink-0 px-3 py-2 bg-green-500 text-white rounded-lg text-sm hover:bg-green-600',
              children: '+',
            }),
            _jsx('button', {
              ...
              className:
                'flex-shrink-0 px-3 py-2 bg-purple-600 text-white rounded-lg text-sm hover:bg-purple-700 disabled:bg-purple-400',
              children: '\uD83D\uDE80 Automate',
            }),
            _jsx('button', {
              onClick: () => setIsRuleModalOpen(true),
              className:
                'flex-shrink-0 px-3 py-2 bg-yellow-500 text-white rounded-lg text-sm hover:bg-yellow-600',
              children: 'Rules',
            }),
            _jsx('button', {
              onClick: () => setIsScenarioModalOpen(true),
              className:
                'flex-shrink-0 px-3 py-2 bg-red-500 text-white rounded-lg text-sm hover:bg-red-600',
              children: '\u2728 Inject',
            }),
            _jsx('input', {
              type: 'text',
            ...
            _jsxs('div', {
              ...
              children: [
                _jsx('span', { className: 'text-sm font-medium', children: 'Mode:' }),
                _jsx('button', {
                  onClick: () => {
                  ...
                  children: mode === 'auto' ? 'Auto' : 'Manual',
                }),
              ],
            }),
          ],
      ...
      _jsxs('main', {
        ...
        children: [
          messages.map((msg) => _jsx(MessageBubble, { message: msg, agents: agents }, msg.id)),
          _jsx('div', { ref: messagesEndRef }),
        ],
      }),
      _jsxs('footer', {
        className: 'bg-white dark:bg-gray-800 shadow-inner',
        children: [
          _jsx('div', {
            className: `transition-all duration-300 ease-in-out overflow-hidden ${isFooterExpanded ? 'max-h-40' : 'max-h-0'}`,
            children: _jsxs('div', {
              className: 'p-2 border-b border-gray-200 dark:border-gray-700 grid grid-cols-2 gap-4',
              children: [
                _jsxs('div', {
                  children: [
                    _jsx('label', {
                    ...
                    _jsxs('select', {
                      ...
                      className:
                        'w-full p-2 border bg-transparent border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:border-blue-500 text-sm',
                      children: [
                        _jsx('option', { value: 'You', children: 'You' }),
                        agents.map((agent) =>
          ...
          _jsxs('div', {
            ...
            children: [
              _jsx('button', {
                ...
                className:
                  'p-2 text-gray-500 hover:text-blue-500 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full',
              ...
              _jsx('div', {
                ...
                children: _jsx('input', {
                  ...
                  className:
                    'w-full p-2 pr-10 border bg-transparent border-gray-300 dark:border-gray-600 rounded-full focus:outline-none focus:border-blue-500',
                }),
              }),
              _jsx('button', {
                onClick: handleSendMessage,
                className:
                  'p-3 bg-blue-500 text-white rounded-full self-end disabled:bg-gray-400 hover:bg-blue-600',

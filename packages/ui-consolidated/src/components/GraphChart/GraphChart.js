...
export function GraphChart({
        ...
        return _jsxs(BarChart, {
          ...
          children: [
            ...
            series
              ...
              : _jsx(Bar, { dataKey: yAxisKey, fill: colors[0] }),
          ],
        });
      case 'pie':
          ...
          children: [
            _jsx(Pie, {
              ...
              children: chartData.map((entry, index) =>
                _jsx(Cell, { fill: entry.color || colors[index % colors.length] }, entry.id)
              ),
            }),
            _jsx(Tooltip, {}),
            _jsx(Legend, {}),
  ...
  return _jsxs('div', {
    ...
    children: [
      title && _jsx('h3', { className: 'text-lg font-semibold mb-4', children: title }),
      _jsx(ResponsiveContainer, { width: width, height: height, children: renderChart() }),
    ],
  });
}

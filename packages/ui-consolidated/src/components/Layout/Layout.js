...
const Layout = React.forwardRef(
  (
    ...
    const defaultHeader = _jsxs('header', {
      className: 'bg-background border-b h-16 flex items-center justify-between px-4',
      children: [
        _jsxs('div', {
          ...
          children: [
            _jsxs('button', {
              type: 'button',
              className:
                'lg:hidden mr-2 p-2 rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground',
              onClick: () => setSidebarOpen(!sidebarOpen),
              children: [
                _jsx('span', { className: 'sr-only', children: 'Open sidebar' }),
                _jsx('svg', {
                  className: 'h-6 w-6',
                  fill: 'none',
                  stroke: 'currentColor',
            ...
            _jsx('div', { className: 'text-xl font-semibold', children: 'The New Fuse' }),
          ],
        }),
        user &&
          _jsxs('div', {
            ...
            children: [
              _jsxs('div', {
                ...
                children: [
                  ...
                  _jsxs('div', {
                    ...
                    children: [
                      _jsx('div', { className: 'text-sm font-medium', children: user.name }),
                      _jsx('div', {
              ...
              _jsx('div', {
                ...
                children: _jsxs('button', {
                  ...
                  onClick: onSettings,
                  children: [
                    _jsx('span', { className: 'sr-only', children: 'Settings' }),
                    _jsxs('svg', {
                      className: 'h-5 w-5',
                      fill: 'none',
                      stroke: 'currentColor',
              ...
              _jsxs('button', {
                ...
                onClick: onLogout,
                children: [
                  _jsx('span', { className: 'sr-only', children: 'Logout' }),
                  _jsx('svg', {
                    className: 'h-5 w-5',
                    fill: 'none',
                    stroke: 'currentColor',
    ...
    const defaultSidebar = _jsxs('aside', {
      className: cn(
        ...
        _jsxs('div', {
          ...
          children: [
            ...
            _jsxs('button', {
              type: 'button',
              className:
                'lg:hidden p-2 rounded-md text-muted-foreground hover:bg-accent hover:text-accent-foreground',
              onClick: () => setSidebarOpen(false),
              children: [
                _jsx('span', { className: 'sr-only', children: 'Close sidebar' }),
                _jsx('svg', {
                  className: 'h-6 w-6',
                  fill: 'none',
                  stroke: 'currentColor',
          ...
          children: navigation.map((item) =>
            _jsxs(
              'a',
              {
                ...
                children: [
                  item.icon && _jsx('span', { className: 'mr-3', children: item.icon }),
                  item.label,
                ],
              },
              item.key || item.href
    ...
    const defaultFooter = _jsx('footer', {
      className: 'bg-background border-t py-4 px-4',
      children: _jsxs('div', {
        className: 'flex flex-col md:flex-row justify-between items-center',
        children: [
          _jsxs('div', {
            className: 'text-sm text-muted-foreground',
            children: ['\u00A9 ', new Date().getFullYear(), ' The New Fuse. All rights reserved.'],
          }),

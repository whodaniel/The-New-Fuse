 ...
 */
const generatePaginationRange = (count, page, siblingCount, boundaryCount) => {
  const range = [];
  // Add first page(s)
...
const Pagination = React.forwardRef(
  (
    ...
    return _jsx(PaginationContext.Provider, {
      value: {
        count,
        page,
          ...
          showFirstLast &&
            _jsx(PaginationItem, {
              ...
              children: _jsxs('svg', {
                ...
                className: 'h-4 w-4',
                children: [
                  _jsx('polyline', { points: '11 17 6 12 11 7' }),
                  _jsx('polyline', { points: '18 17 13 12 18 7' }),
                ],
              }),
            }),
          showControls &&
          ...
          showFirstLast &&
            _jsx(PaginationItem, {
              ...
              children: _jsxs('svg', {
                ...
                className: 'h-4 w-4',
                children: [
                  _jsx('polyline', { points: '13 17 18 12 13 7' }),
                  _jsx('polyline', { points: '6 17 11 12 6 7' }),
                ],
              }),
            }),
        ],

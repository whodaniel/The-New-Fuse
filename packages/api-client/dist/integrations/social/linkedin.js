...
export class LinkedInIntegration {
     ...
     */
    async createPost(text, visibility = 'PUBLIC', media) {
        try {
            const payload = {
     ...
     */
    async shareUpdate(content, visibility = 'PUBLIC') {
        try {
            const payload = {
                content,
                distribution: {
     ...
     */
    async sendInvitation(recipient, message) {
        try {
            const payload = {
                invitee: {
     ...
     */
    async createCompanyPost(companyId, content) {
        try {
            const payload = {
     ...
     */
    async getAnalytics(companyId, timeRange) {
        try {
     ...
     */
    async searchCompanies(keywords, filters) {
        try {
 ...
 */
export function createLinkedInIntegration(config = {}) {
    const defaultConfig = {
        id: 'linkedin',
        name: 'LinkedIn',

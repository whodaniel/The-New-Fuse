...
export class TwitterIntegration {
     ...
     */
    async getUserTweets(user_id, max_results = 10) {
        try {
     ...
     */
    async getUserProfile(user_identifier) {
        try {
     ...
     */
    async getUserFollowers(user_id, max_results = 100) {
        try {
     ...
     */
    async getUserFollowing(user_id, max_results = 100) {
        try {
     ...
     * Follow a user
     */
    async followUser(target_user_id) {
        try {
     ...
     * Unfollow a user
     */
    async unfollowUser(target_user_id) {
        try {
            // Need user ID of authenticated user
            const me = await this.apiClient.get('/2/users/me');
            const userId = me.data.id;
     ...
     * Search for tweets
     */
    async searchTweets(query, max_results = 10) {
        try {
     ...
     */
    async uploadMedia(media_data, media_type) {
        try {
...
export function createTwitterIntegration(config = {}) {
    const defaultConfig = {
        id: 'twitter',
        name: 'Twitter',
        type: IntegrationType.SOCIAL || 'social',

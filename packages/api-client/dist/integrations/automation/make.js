...
export class MakeIntegration {
     ...
     */
    async createScenario(teamId, name, blueprint) {
        try {
            const payload = {
                name,
                teamId
     ...
     */
    async createConnection(teamId, appId, name, data) {
        try {
     ...
     */
    async getScenarioExecutionHistory(scenarioId, options = {}) {
        try {
     ...
     */
    async listDataStoreRecords(dataStoreId, options = {}) {
        try {
     ...
     */
    async createDataStoreRecord(dataStoreId, data) {
        try {
     ...
     */
    async updateDataStoreRecord(dataStoreId, recordId, data) {
        try {
     ...
     */
    async deleteDataStoreRecord(dataStoreId, recordId) {
        try {
     ...
     */
    async createWebhook(scenarioId, hookUrl) {
        try {
 ...
 */
export function createMakeIntegration(config = {}) {
    const defaultConfig = {
        id: 'make',
        name: 'Make',

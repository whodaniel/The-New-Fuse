...
import { IntegrationType } from '../integrations/types.js';
/**
 * Events emitted by the Integration Marketplace
 */
export var MarketplaceEvent;
(function (MarketplaceEvent) {
    MarketplaceEvent["INSTALLED"] = "integration:installed";
    MarketplaceEvent["UNINSTALLED"] = "integration:uninstalled";
    MarketplaceEvent["UPDATED"] = "integration:updated";
    MarketplaceEvent["DISCOVERED"] = "integration:discovered";
...
(function (InstallationStatus) {
    InstallationStatus["NOT_INSTALLED"] = "not_installed";
    InstallationStatus["INSTALLING"] = "installing";
    InstallationStatus["INSTALLED"] = "installed";
    InstallationStatus["UPDATE_AVAILABLE"] = "update_available";
...
export class MarketplaceService {
    constructor(integrationRegistry, loggingService, discoveryEndpoint) {
    ...
    getListings(filter) {
        ...
        if (filter) {
            ...
            if (filter.search) {
                ...
                listings = listings.filter(listing => listing.name.toLowerCase().includes(searchLower) ||
     ...
     */
    async simulateInstallation(listing) {

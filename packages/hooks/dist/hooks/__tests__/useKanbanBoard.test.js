...
describe('useKanbanBoard', () => {
    ...
    it('should initialize with empty state and load data', async () => {
        const { result, waitForNextUpdate } = renderHook(() => useKanbanBoard({ suggestionService: mockSuggestionService }));
    ...
    it('should update suggestion status', async () => {
        ...
        expect(mockSuggestionService.updateSuggestionStatus).toHaveBeenCalledWith('1', SuggestionStatus.UNDER_REVIEW);
    ...
    it('should update todo status', async () => {
        ...
        expect(mockSuggestionService.updateTodoStatus).toHaveBeenCalledWith('1', TaskStatus.IN_PROGRESS);
...
//# sourceMappingURL=useKanbanBoard.test.js.map
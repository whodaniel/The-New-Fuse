...
export type NodeConfigForType<T extends WorkflowNodeType> = T extends keyof WorkflowNodeConfigMap ? WorkflowNodeConfigMap[T] : NodeConfiguration;
export declare function isAgentTaskNode(node: WorkflowNode): node is WorkflowNode & {
    config: AgentTaskNodeConfig;
};
export declare function isAgentHandoffNode(node: WorkflowNode): node is WorkflowNode & {
    config: AgentHandoffNodeConfig;
};
export declare function isConditionNode(node: WorkflowNode): node is WorkflowNode & {
    config: ConditionNodeConfig;
};
export declare function isLLMPromptNode(node: WorkflowNode): node is WorkflowNode & {
    config: LLMPromptNodeConfig;
};

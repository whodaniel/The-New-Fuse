import { PipelineConfig, PipelineResult, BuildResult, DeploymentResult, RollbackResult } from '../types/pipeline.js';
...
export declare class PipelineStorage {
     ...
     */
    getPipelineConfig(configId: string): Promise<PipelineConfig | null>;
    /**
     * Get all pipeline configurations
     */
    getAllPipelineConfigs(): Promise<PipelineConfig[]>;
    /**
     * Store pipeline execution result
     */
    storePipelineResult(result: PipelineResult): Promise<void>;
    /**

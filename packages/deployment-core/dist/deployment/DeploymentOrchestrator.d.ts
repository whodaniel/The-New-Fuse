...
import { DeploymentConfig, DeploymentResult, RollbackResult } from '../types/pipeline.js';
import { DeploymentProgress } from './DeploymentStrategy.js';
/**
...
export declare class DeploymentOrchestrator extends EventEmitter {
     ...
     */
    requestApproval(deploymentId: string, approvers: string[], reason?: string): Promise<DeploymentApproval>;
    /**
    ...
    private executeDeploymentGates;
    private postDeploymentValidation;
    private validateEnvironmentReadiness;

 ...
 */
import { InfrastructureTemplate, InfrastructureUpdate, InfrastructureChange, ExecutionPlan, ProvisionResult, UpdateResult, DestroyResult, ValidationResult, PlanResult, ApplyResult, InfrastructureState, CloudProvider } from '../types/infrastructure.js';
...
export declare enum HealthLevel {
    HEALTHY = "healthy",
    DEGRADED = "degraded",
    UNHEALTHY = "unhealthy",
    UNKNOWN = "unknown"
...
export declare enum SecurityRecommendationType {
...
//# sourceMappingURL=IInfrastructureManager.d.ts.map
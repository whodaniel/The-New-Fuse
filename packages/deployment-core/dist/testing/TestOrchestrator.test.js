...
const TestOrchestrator_js_1 = require("./TestOrchestrator.js");
...
describe('TestOrchestrator', () => {
    ...
    beforeEach(() => {
        ...
        orchestrator = new TestOrchestrator_js_1.TestOrchestrator(mockLogger);
        // Get the mocked TestRunner instance
        mockTestRunner = orchestrator.testRunner;
        // Setup default mock implementations
        mockTestRunner.executeTests.mockResolvedValue({
            id: 'test-1',
            type: TestOrchestrator_js_1.TestType.UNIT,
            status: TestRunner_js_1.TestStatus.PASSED,
            startTime: new Date(),
            endTime: new Date(),
            duration: 1000,
            totalTests: 10,
    ...
    describe('generatePlanTemplate', () => {
        it('should generate a test plan template with specified test types', () => {
            const testTypes = [TestOrchestrator_js_1.TestType.UNIT, TestOrchestrator_js_1.TestType.INTEGRATION, TestOrchestrator_js_1.TestType.E2E];
        ...
        it('should create stages with proper dependencies', () => {
            const testTypes = [TestOrchestrator_js_1.TestType.UNIT, TestOrchestrator_js_1.TestType.INTEGRATION];
            const template = orchestrator.generatePlanTemplate('Test Project', testTypes);
    ...
    describe('executePlan', () => {
        it('should execute a simple test plan', async () => {
            ...
            expect(result.status).toBe(TestOrchestrator_js_1.TestPlanStatus.COMPLETED);
        ...
        it('should handle plan execution failure', async () => {
            ...
            const result = await orchestrator.executePlan(plan);
            expect(result).toBeDefined();
            expect(result.status).toBe(TestOrchestrator_js_1.TestPlanStatus.FAILED);
...
//# sourceMappingURL=TestOrchestrator.test.js.map
 ...
 */
import { EnvironmentType } from '../types/infrastructure.js';
...
export declare class EnvironmentManager {
    ...
    updateEnvironment(environmentId: string, updates: Partial<EnvironmentConfiguration>): Promise<Environment>;
    deleteEnvironment(environmentId: string): Promise<void>;
    promoteEnvironment(promotion: EnvironmentPromotion): Promise<void>;
    ...
    private generateEnvironmentTemplate;
    private configurationToVariables;
    private runValidationCheck;
    private performBlueGreenPromotion;
    private performCanaryPromotion;
    private performRollingPromotion;
}

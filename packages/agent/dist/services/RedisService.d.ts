...
export declare class RedisService extends BaseService {
    ...
    getHealth(): Promise<import("@the-new-fuse/infrastructure", { with: { "resolution-mode": "import" } }).RedisHealth>;
    getMetrics(): import("@the-new-fuse/infrastructure", { with: { "resolution-mode": "import" } }).RedisMetrics;
}

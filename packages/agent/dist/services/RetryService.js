...
class RetryService extends BaseService_1.BaseService {
    constructor() {
        ...
        this.logger = new core_1.Logger('RetryService');
    ...
    async execute(operation, options) {
        ...
        while (attempt < config.maxAttempts) {
            ...
            try {
                ...
                currentDelay = Math.min(currentDelay * (config.backoffMultiplier ?? DEFAULT_RETRY_OPTIONS.backoffMultiplier), config.maxDelayMs);
            }
        }

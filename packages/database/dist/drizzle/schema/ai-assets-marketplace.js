...
import { index, integer, jsonb, pgSchema, text, timestamp, uniqueIndex, varchar, } from 'drizzle-orm/pg-core';
export const aiAssetsMarketplace = pgSchema('ai_assets_marketplace');
// =============================================================================
// INGESTION TABLES
// =============================================================================
export const aiAssetCategories = aiAssetsMarketplace.table('categories', {
...
export const aiAssetSources = aiAssetsMarketplace.table('sources', {
    id: integer('id').primaryKey(),
...
export const aiAssetSourceLinks = aiAssetsMarketplace.table('source_links', {
    id: integer('id').primaryKey(),
    ...
    sourceUrlUniqueIdx: uniqueIndex('ai_assets_source_links_source_url_uq').on(table.sourceId, table.linkUrl),
}));
export const aiAssetPrompts = aiAssetsMarketplace.table('prompts', {
    id: integer('id').primaryKey(),
    sourceId: integer('source_id').notNull(),
    title: text('title'),
    ...
    sourceHashUniqueIdx: uniqueIndex('ai_assets_prompts_source_hash_uq').on(table.sourceId, table.promptHash),
}));
...
export const aiAssetCrawlRuns = aiAssetsMarketplace.table('crawl_runs', {
...
export const aiAssetSkillMarketplaceEntries = aiAssetsMarketplace.table('skill_marketplace_entries', {
    id: integer('id').primaryKey(),
    ...
    sourceEntryUrlUniqueIdx: uniqueIndex('ai_assets_skill_marketplace_entries_source_url_uq').on(table.source, table.entryUrl),
}));
export const aiAssetMcpCategories = aiAssetsMarketplace.table('mcp_categories', {
    id: integer('id').primaryKey(),
    name: text('name').notNull(),
    description: text('description').notNull(),
}, (table) => ({
...
export const aiAssetMcpSources = aiAssetsMarketplace.table('mcp_sources', {
    id: integer('id').primaryKey(),
    categoryId: integer('category_id').notNull(),
    name: text('name').notNull(),
    url: text('url').notNull(),
...
export const aiAssetMcpLinks = aiAssetsMarketplace.table('mcp_links', {
    id: integer('id').primaryKey(),
    sourceId: integer('source_id').notNull(),
    linkUrl: text('link_url').notNull(),
    anchor: text('anchor'),
    ...
    sourceUrlUniqueIdx: uniqueIndex('ai_assets_mcp_links_source_url_uq').on(table.sourceId, table.linkUrl),
}));
export const aiAssetMcpServers = aiAssetsMarketplace.table('mcp_servers', {
    id: integer('id').primaryKey(),
    ...
    serverRepoUniqueIdx: uniqueIndex('ai_assets_mcp_servers_server_repo_uq').on(table.serverUrl, table.repoUrl),
}));
// =============================================================================
// RELATIONS
// =============================================================================

...
import { boolean, integer, jsonb, pgTable, real, text, timestamp, uuid, varchar, index, } from 'drizzle-orm/pg-core';
...
export const agentTracking = pgTable('agent_tracking', {
    ...
    reputationFactors: jsonb('reputation_factors').$type().default({

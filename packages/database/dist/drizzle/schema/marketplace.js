...
import { boolean, decimal, index, integer, jsonb, pgTable, real, text, timestamp, uniqueIndex, uuid, varchar, } from 'drizzle-orm/pg-core';
...
// =============================================================================
export const marketplaceCatalogItems = pgTable('marketplace_catalog_items', {
    ...
    capabilities: jsonb('capabilities').$type().default([]).notNull(),

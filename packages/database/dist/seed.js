...
const SEED_AGENTS = [
    {
        name: 'CodeMaster Pro',
        description: 'Advanced AI assistant specialized in code generation and analysis across multiple programming languages',
        ...
        systemPrompt: 'You are CodeMaster Pro, an expert AI coding assistant. You help developers write clean, efficient, and maintainable code.',
        configuration: {
            maxTokens: 4096,
            temperature: 0.7,
    ...
    },
    {
        ...
        systemPrompt: 'You are DataFlow Orchestrator, a workflow automation expert. You design and execute efficient data pipelines.',
        configuration: {
    ...
    },
    {
        ...
        systemPrompt: 'You are ChatBot Ultimate, a friendly and helpful conversational AI. You assist users with their inquiries while maintaining a positive tone.',
        configuration: {
    ...
    },
    {
        ...
        description: 'Data analysis agent for generating insights and visualizations from complex datasets',
        type: 'ANALYSIS',
        status: 'READY',
        capabilities: [
            'DATA_PROCESSING',
        ...
        systemPrompt: 'You are Analytics Insight, a data analysis expert. You transform raw data into actionable insights and recommendations.',
        configuration: {
    ...
    },
    {
        ...
        systemPrompt: 'You are WebResearch Agent, a research specialist. You efficiently gather and synthesize information from web sources.',
        configuration: {
            maxResults: 50,
    ...
    },
    {
        ...
        systemPrompt: 'You are SecureScan Pro, a security analysis expert. You identify vulnerabilities and recommend security improvements.',
        configuration: {
    ...
    },
    {
        ...
        systemPrompt: 'You are DocuWriter Assistant, a documentation expert. You create clear, comprehensive technical documentation.',
        configuration: {
    ...
    },
    {
        ...
        description: 'IDE extension agent for providing AI-powered coding assistance within development environments',
        type: 'IDE_EXTENSION',
        status: 'READY',
        capabilities: [
            'CODE_GENERATION',
        ...
        systemPrompt: 'You are IDE Integration Bot, an in-editor AI assistant. You provide context-aware coding suggestions and assistance.',
        configuration: {
            autoComplete: true,
    ...
    },
    {
        ...
        description: 'API integration agent for managing external service connections and data exchange',
        type: 'API',
        status: 'BUSY',
        capabilities: [
            'API_INTEGRATION',
        ...
        systemPrompt: 'You are API Gateway Agent, an integration specialist. You manage API connections and ensure smooth data flow.',
        configuration: {
            rateLimiting: true,
    ...
    },
    {
        ...
        systemPrompt: 'You are Multimedia Processor, a media analysis expert. You process and analyze various media formats efficiently.',
        configuration: {
...
async function seedAdditionalAgents(userId) {
    ...
    const additionalAgents = [
        ...
        },
        {
            ...
            systemPrompt: 'You are System Initializer Gamma, responsible for system setup and initialization.',

...
export class CronService {
  ...
  private getDefaultJobs(): CronJob[] {
    ...
    {
      id: 'marketplace-prompt-curator',
      name: 'Marketplace Prompt Curator',
      schedule: '0 */12 * * *',
      command: 'tnf marketplace curate --source prompts',
      enabled: true,
      description: 'Crawl and curate new prompts for the marketplace',
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
      runCount: 0,
      failCount: 0,

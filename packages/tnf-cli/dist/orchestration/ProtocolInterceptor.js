...
import { TurnZeroService } from './TurnZeroService.js';
export class ProtocolInterceptor {
    ...
    async runPreFlightChecks() {
        ...
        const livingStateOk = livingStateContent !== null && livingStateContent.includes('[STATUS:SYNCHRONIZED]');
        checks.push({
    ...
    enforceTurnZero() {
        ...
        if (missing.length > 0) {
            console.warn(chalk.yellow(`[ProtocolInterceptor] Turn Zero enforcement: ${missing.length} file(s) missing:`));
...
//# sourceMappingURL=ProtocolInterceptor.js.map
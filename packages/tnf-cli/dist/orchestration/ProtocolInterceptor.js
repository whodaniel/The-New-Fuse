    ...
    enforceTurnZeroMandate() {
        ...
        for (const file of requiredFiles) {
            ...
            if (!fs.existsSync(fullPath)) {
                console.warn(chalk.yellow(`[ProtocolInterceptor] WARNING: Turn Zero artifact missing: ${file}`));
                console.warn(chalk.dim(`  Agents should not operate without synchronizing state. See docs/protocols/TURN_ZERO_MANDATE.md`));
            }
        }
    }
    /**

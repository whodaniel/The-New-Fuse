import { DataType, ViewType, FilterOperator } from './types.js';
...
export const getDefaultGridView = () => ({
    id: generateId(),
    name: 'Grid',
    type: ViewType.GRID,
    filters: [],

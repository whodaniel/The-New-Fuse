...
exports.WebVitalsMonitor = exports.VITALS_THRESHOLDS = void 0;
exports.createWebVitalsMonitor = createWebVitalsMonitor;
/**
 * Web Vitals thresholds (from web.dev)
 */
exports.VITALS_THRESHOLDS = {
...
class WebVitalsMonitor {
    ...
    getRating(name, value) {
        const thresholds = exports.VITALS_THRESHOLDS[name];
        if (!thresholds)
            return 'good';
 ...
 */
async function createWebVitalsMonitor(config) {

        ...
        try {
            ...
            if (this.config.console?.enabled !== false) {
                transports.push(new this.winston.transports.Console({
                    format: this.winston.format.combine(this.winston.format.timestamp(), this.config.console?.colorize ? this.winston.format.colorize() : this.winston.format.uncolorize(), this.winston.format.printf(this.formatConsoleLog.bind(this))),
                }));
            }
            // File transports
            if (this.config.file?.enabled) {
                ...
                if (this.winstonDailyRotate) {
                    ...
                    transports.push(new this.winstonDailyRotate.default({
                        dirname: fileDir,
                    ...
                    transports.push(new this.winston.transports.File({
                        dirname: fileDir,

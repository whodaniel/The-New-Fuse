 ...
 */
export class NetworkReconnectionStrategy {
    constructor() {
        this.name = 'NetworkReconnection';
        this.applicableErrorCodes = [
        ...
        this.maxAttempts = 3;
        this.delay = 2000;
        this.logger = new Logger('NetworkReconnectionStrategy');
    }
...
export class TokenRefreshStrategy {
    constructor(refreshCallback) {
        this.name = 'TokenRefresh';
        this.applicableErrorCodes = [ErrorCodes.TOKEN_EXPIRED, ErrorCodes.AUTH_ERROR];
        this.maxAttempts = 1;
        this.delay = 0;
        this.logger = new Logger('TokenRefreshStrategy');
 ...
 */
export class CacheFallbackStrategy {
    constructor(cacheProvider) {
        this.name = 'CacheFallback';
        this.applicableErrorCodes = [
            ErrorCodes.NETWORK_ERROR,
            ErrorCodes.TIMEOUT,
        ...
        this.maxAttempts = 1;
        this.delay = 0;
        this.logger = new Logger('CacheFallbackStrategy');
 ...
 */
export class ServiceFailoverStrategy {
    constructor() {
        this.name = 'ServiceFailover';
        this.applicableErrorCodes = [
            ErrorCodes.SERVICE_UNAVAILABLE,
        ...
        this.maxAttempts = 2;
        this.delay = 1000;
        this.logger = new Logger('ServiceFailoverStrategy');
        this.backupServices = new Map();
        this.currentServiceIndex = new Map();
    }
    async recover(error, context) {
 ...
 */
export class DataSanitizationStrategy {
    constructor() {
        this.name = 'DataSanitization';
        this.applicableErrorCodes = [ErrorCodes.VALIDATION_ERROR, ErrorCodes.INVALID_FORMAT];
        this.maxAttempts = 1;
        this.delay = 0;
        this.logger = new Logger('DataSanitizationStrategy');
 ...
 */
export class GracefulDegradationStrategy {
    constructor() {
        this.name = 'GracefulDegradation';
        this.applicableErrorCodes = [
            ErrorCodes.SERVICE_UNAVAILABLE,
            ErrorCodes.EXTERNAL_SERVICE_ERROR,
        ...
        this.maxAttempts = 1;
        this.delay = 0;
        this.logger = new Logger('GracefulDegradationStrategy');
 ...
 */
export class RateLimitBackoffStrategy {
    constructor() {
        this.name = 'RateLimitBackoff';
        this.applicableErrorCodes = [ErrorCodes.RATE_LIMIT];
        this.maxAttempts = 3;
        this.delay = 5000;
        this.logger = new Logger('RateLimitBackoffStrategy');
    }
    async recover(error, context) {
 ...
 */
export class DatabaseRollbackStrategy {
    constructor(rollbackCallback) {
        this.name = 'DatabaseRollback';
        this.applicableErrorCodes = [ErrorCodes.DATABASE_ERROR];
        this.maxAttempts = 1;
        this.delay = 0;
        this.logger = new Logger('DatabaseRollbackStrategy');

...
exports.defaultRecoveryStrategies = exports.DatabaseRollbackStrategy = exports.RateLimitBackoffStrategy = exports.GracefulDegradationStrategy = exports.DataSanitizationStrategy = exports.ServiceFailoverStrategy = exports.CacheFallbackStrategy = exports.TokenRefreshStrategy = exports.NetworkReconnectionStrategy = void 0;
...
class TokenRefreshStrategy {
    name = 'TokenRefresh';
    applicableErrorCodes = [CustomErrors_js_1.ErrorCodes.TOKEN_EXPIRED, CustomErrors_js_1.ErrorCodes.AUTH_ERROR];
    maxAttempts = 1;
    delay = 0;
...
class DataSanitizationStrategy {
    ...
    applicableErrorCodes = [CustomErrors_js_1.ErrorCodes.VALIDATION_ERROR, CustomErrors_js_1.ErrorCodes.INVALID_FORMAT];
    maxAttempts = 1;
    delay = 0;

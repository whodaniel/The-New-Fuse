...
exports.ErrorCodes = exports.InsufficientFundsError = exports.PaymentDeclinedError = exports.PaymentError = exports.ApiIntegrationError = exports.IntegrationError = exports.FileSystemError = exports.ExternalServiceError = exports.ServiceUnavailableError = exports.ConfigurationError = exports.DatabaseError = exports.SystemError = exports.RateLimitError = exports.OperationNotAllowedError = exports.DuplicateResourceError = exports.ConflictError = exports.NotFoundError = exports.BusinessError = exports.OutOfRangeError = exports.InvalidFormatError = exports.RequiredFieldError = exports.ValidationError = exports.InsufficientPermissionsError = exports.AuthorizationError = exports.InvalidCredentialsError = exports.TokenExpiredError = exports.AuthenticationError = exports.HttpError = exports.ConnectionError = exports.TimeoutError = exports.NetworkError = exports.ApplicationError = void 0;
...
class ApplicationError extends Error {
    ...
    metadata;
    originalError;
    constructor(message, code, severity = IErrorHandling_js_1.ErrorSeverity.MEDIUM, category = IErrorHandling_js_1.ErrorCategory.UNKNOWN, retryable = false, metadata, originalError) {
        super(message);
...
class NetworkError extends ApplicationError {
    ...
    constructor(message, code = 1000, metadata, originalError) {
        super(message, code, IErrorHandling_js_1.ErrorSeverity.HIGH, IErrorHandling_js_1.ErrorCategory.NETWORK, true, // Network errors are typically retryable
...
class AuthenticationError extends ApplicationError {
    constructor(message = 'Authentication failed', code = 2000, metadata, originalError) {
        super(message, code, IErrorHandling_js_1.ErrorSeverity.HIGH, IErrorHandling_js_1.ErrorCategory.AUTHENTICATION, false, // Auth errors typically require user action
        metadata, originalError);
    }
}
...
class AuthorizationError extends ApplicationError {
    ...
    constructor(message = 'Access denied', requiredPermission, userRole, originalError) {
        super(message, 2100, IErrorHandling_js_1.ErrorSeverity.MEDIUM, IErrorHandling_js_1.ErrorCategory.AUTHORIZATION, false, { requiredPermission, userRole }, originalError);
...
class ValidationError extends ApplicationError {
    ...
    constructor(message, field, validationErrors, originalError) {
        super(message, 3000, IErrorHandling_js_1.ErrorSeverity.LOW, IErrorHandling_js_1.ErrorCategory.VALIDATION, false, { field, validationErrors }, originalError);
        this.field = field;
...
class BusinessError extends ApplicationError {
    constructor(message, code = 4000, severity = IErrorHandling_js_1.ErrorSeverity.MEDIUM, metadata, originalError) {
        super(message, code, severity, IErrorHandling_js_1.ErrorCategory.BUSINESS, false, metadata, originalError);
    }
}
    ...
    constructor(resourceType, resourceId) {
        super(resourceType && resourceId
            ...
            : resourceType
                ...
                : 'Resource not found', 4001, IErrorHandling_js_1.ErrorSeverity.LOW, { resourceType, resourceId });
...
class OperationNotAllowedError extends BusinessError {
    constructor(operation, reason) {
        super(`Operation '${operation}' is not allowed${reason ? `: ${reason}` : ''}`, 4004, IErrorHandling_js_1.ErrorSeverity.MEDIUM, { operation, reason });
    }
}
...
class RateLimitError extends BusinessError {
    ...
    constructor(retryAfter) {
        super(`Rate limit exceeded${retryAfter ? `. Retry after ${retryAfter} seconds` : ''}`, 4005, IErrorHandling_js_1.ErrorSeverity.LOW, { retryAfter });
...
class SystemError extends ApplicationError {
    constructor(message, code = 5000, severity = IErrorHandling_js_1.ErrorSeverity.CRITICAL, retryable = true, metadata, originalError) {
        super(message, code, severity, IErrorHandling_js_1.ErrorCategory.SYSTEM, retryable, metadata, originalError);
    }
}
...
class DatabaseError extends SystemError {
    ...
    constructor(message, operation, query, originalError) {
        super(message, 5001, IErrorHandling_js_1.ErrorSeverity.CRITICAL, true, { operation, query }, originalError);
        this.query = query;
...
class ConfigurationError extends SystemError {
    ...
    constructor(message, configKey, originalError) {
        super(message, 5002, IErrorHandling_js_1.ErrorSeverity.CRITICAL, false, // Config errors typically need manual fix
...
class ServiceUnavailableError extends SystemError {
    ...
    constructor(serviceName, originalError) {
        super(serviceName ? `Service '${serviceName}' is unavailable` : 'Service unavailable', 5003, IErrorHandling_js_1.ErrorSeverity.HIGH, true, { serviceName }, originalError);
...
class ExternalServiceError extends SystemError {
    ...
    constructor(serviceName, message, statusCode, originalError) {
        super(message || `External service '${serviceName}' error`, 5004, IErrorHandling_js_1.ErrorSeverity.HIGH, true, { serviceName, statusCode }, originalError);
        this.serviceName = serviceName;
...
class FileSystemError extends SystemError {
    ...
    constructor(message, path, operation, originalError) {
        super(message, 5005, IErrorHandling_js_1.ErrorSeverity.HIGH, false, { path, operation }, originalError);
        this.path = path;
        this.operation = operation;
    }
}
...
class IntegrationError extends ApplicationError {
    ...
    constructor(provider, message, operation, originalError) {
        super(message || `Integration error with ${provider}`, 6000, IErrorHandling_js_1.ErrorSeverity.HIGH, IErrorHandling_js_1.ErrorCategory.SYSTEM, true, { provider, operation }, originalError);
...
class PaymentError extends ApplicationError {
    ...
    constructor(message, code = 7000, metadata, originalError) {
        super(message, code, IErrorHandling_js_1.ErrorSeverity.CRITICAL, IErrorHandling_js_1.ErrorCategory.BUSINESS, false, metadata, originalError);

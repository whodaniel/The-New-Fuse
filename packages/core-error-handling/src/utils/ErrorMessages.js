...
exports.errorMessageFormatter = exports.ErrorMessageFormatter = void 0;
exports.getUserFriendlyMessage = getUserFriendlyMessage;
const CustomErrors_js_1 = require("../errors/CustomErrors.js");
const CustomErrors_js_2 = require("../errors/CustomErrors.js");
/**
...
const ERROR_MESSAGES = {
    ...
    [CustomErrors_js_1.ErrorCodes.INVALID_CREDENTIALS]: {
        en: {
            title: 'Login Failed',
    ...
    [CustomErrors_js_1.ErrorCodes.AUTHORIZATION_ERROR]: {
        en: {
            title: 'Access Denied',
    ...
    [CustomErrors_js_1.ErrorCodes.NOT_FOUND]: {
        en: {
            title: 'Not Found',
    ...
    [CustomErrors_js_1.ErrorCodes.RATE_LIMIT]: {
        en: {
...
class ErrorMessageFormatter {
    ...
    format(error, language) {
        ...
        if (error instanceof CustomErrors_js_2.ApplicationError) {
 ...
 */
exports.errorMessageFormatter = new ErrorMessageFormatter();
/**
 * Convenience function to get user-friendly error message
 */
function getUserFriendlyMessage(error, language) {
    return exports.errorMessageFormatter.format(error, language);
}

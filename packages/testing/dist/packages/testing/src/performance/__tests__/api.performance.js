...
const PerformanceSuite_js_1 = require("../PerformanceSuite.js");
...
describe('API Performance Tests', () => {
    ...
    beforeAll(() => {
        ...
        config = {
            ...
            configService: jest.fn() // Mock the private property
        };
        suite = new PerformanceSuite_js_1.PerformanceSuite({
    ...
    describe('Request Handling', () => {
        it('should handle concurrent API requests efficiently', async () => {
            const result = await suite.test(async () => {
                ...
                const requests = Array.from({ length: 100 }).map(() => fetch('http://localhost:3000/api/data'));
...
//# sourceMappingURL=api.performance.js.map
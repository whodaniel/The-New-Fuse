        ...
        this.tools = [
            {
                ...
                description: "Send a prompt to Chrome's built-in Gemini AI. Gemini can see tab contents and access the internet. Use this for web research, content analysis, or any task that benefits from free AI compute.",
                inputSchema: {
                    type: 'object',
                    properties: {
                        prompt: {

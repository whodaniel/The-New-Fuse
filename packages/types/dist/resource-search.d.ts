...
export type ResourceCategoryFilter = 'development' | 'productivity' | 'communication' | 'data' | 'automation' | 'ai' | 'other' | 'all';
...
export interface ResourceSearchEnvelope<TResource extends ResourceCatalogItem = ResourceCatalogItem> {
    items: TResource[];
    traitScreen?: ResourceSearchMeta;
}
export type ResourceSearchResponse<TResource extends ResourceCatalogItem = ResourceCatalogItem> = TResource[] | ResourceSearchEnvelope<TResource>;
//# sourceMappingURL=resource-search.d.ts.map
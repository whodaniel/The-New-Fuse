...
import { MCPError, MCPRequest, MCPResponse } from '../interfaces/IMCPMessage.js';
  ...
  async handleRequest(request: MCPRequest): Promise<MCPResponse> {
    ...
    try {
      ...
      try {
        ...
        // Always release the request timer so completed requests do not keep
        // the event loop (and test runs) alive.

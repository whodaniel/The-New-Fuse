 ...
 */
export type { MCPCapability, CapabilityMetadata, CapabilityDependency, CapabilityStatus, CapabilityMetrics, CapabilityRegistry } from '../interfaces/IMCPCapability.js';
/**
 ...
 */
export declare enum CapabilityLifecycleState {
    DRAFT = "draft",
    PROPOSED = "proposed",
    ACCEPTED = "accepted",
 ...
 */
export declare enum CapabilityCompatibilityLevel {
    FULL = "full",
    PARTIAL = "partial",
    NONE = "none"
}

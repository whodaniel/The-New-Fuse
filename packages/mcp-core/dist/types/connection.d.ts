 ...
 */
export type { ConnectionStatus, AuthConfig, TLSConfig, ConnectionOptions, ConnectionMetrics, MCPConnection, IConnectionManager } from '../interfaces/IMCPConnection.js';
/**
...
export interface ConnectionFactory {
     ...
     */
    createConnection(type: ConnectionType, endpoint: string, options: import('../interfaces/IMCPConnection').ConnectionOptions): Promise<import('../interfaces/IMCPConnection').MCPConnection>;
    /**

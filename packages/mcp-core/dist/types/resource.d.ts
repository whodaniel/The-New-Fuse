 ...
 */
export type { ResourceHandler, MCPResource, ResourceContent, ResourcePermissions, AccessControlEntry, ResourceCaching, ResourceCallback } from '../interfaces/IMCPResource.js';
/**
 ...
 */
export declare enum ResourceAccessMode {
    READ_ONLY = "read_only",

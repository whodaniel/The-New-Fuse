...
export class SkIDEancerMCPBridge {
     ...
     */
    async registerSkIDEancerResources() {
     ...
     */
    static createSkIDEancerCompatibleServer(config = {}) {
        const defaultConfig = {
            server: {
                name: 'ide-mcp-server',
                version: '1.0.0',
     ...
     */
    static async registerWithSkIDEancer(server) {
        try {
 ...
 */
export function createSkIDEancerMCPBridge(config) {

...
import { IMCPServiceMesh, ServiceMeshRegistration, ServiceMeshQuery, ServiceMeshMetrics, ServiceScalingConfig, ServiceMeshIntegrationResult, AutoDiscoveryConfig, ServiceMeshIntegrationStatus, ScalingEvent } from '../interfaces/IMCPServiceMesh.js';
import { MCPServiceInfo, ServiceHealth } from '../types/broker.js';
export type { ServiceMeshRegistration, ServiceMeshQuery, ServiceMeshMetrics, ServiceScalingConfig, ServiceMeshIntegrationResult, ScalingEvent, ScalingPolicy } from '../interfaces/IMCPServiceMesh.js';
/**

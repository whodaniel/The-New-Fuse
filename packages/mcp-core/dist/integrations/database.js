...
export const DatabaseIntegration = {
    ...
    async saveServiceInfo(serviceInfo) {
        ...
        try {
            ...
            const result = await this.executeWithRetry(() => drizzle.mcpService?.upsert({
    ...
    async getServiceInfo(serviceId) {
        ...
        try {
            const result = await this.executeWithRetry(() => drizzle.mcpService?.findUnique({
                where: { id: serviceId },
                include: {
                    metrics: {
    ...
    async getAllServices(filters) {
        ...
        try {
            ...
            const result = await this.executeWithRetry(() => drizzle.mcpService?.findMany({
                where,
                take: filters?.limit,
                skip: filters?.offset,
    ...
    async deleteService(serviceId) {
        ...
        try {
            await this.executeWithRetry(() => drizzle.mcpService?.delete({
                where: { id: serviceId }
            }) || Promise.resolve());
            return true;
        }
    ...
    async saveMetrics(metrics) {
        ...
        try {
            await this.executeWithRetry(() => drizzle.mcpServiceMetrics?.create({
                data: {
                    ...metrics,
                    timestamp: new Date()
                }
    ...
    async getMetrics(serviceId, options) {
        ...
        try {
            ...
            const result = await this.executeWithRetry(() => drizzle.mcpServiceMetrics?.findMany({
                where,
                orderBy: { timestamp: 'desc' },
    ...
    async logAudit(auditLog) {
        ...
        try {
            await this.executeWithRetry(() => drizzle.mcpAuditLog?.create({
                data: {
    ...
    async getAuditLogs(serviceId, options) {
        ...
        try {
            ...
            const result = await this.executeWithRetry(() => drizzle.mcpAuditLog?.findMany({
                where,
                orderBy: { timestamp: 'desc' },
                take: options?.limit || 100,
                skip: options?.offset
    ...
    async cleanup(options) {
        ...
        try {
            ...
            if (options?.metricsRetentionDays) {
                ...
                const deletedMetrics = await this.executeWithRetry(() => drizzle.mcpServiceMetrics?.deleteMany({
                    where: {
            ...
            if (options?.auditRetentionDays) {
                ...
                const deletedAudits = await this.executeWithRetry(() => drizzle.mcpAuditLog?.deleteMany({
                    where: {
            ...
            if (options?.inactiveServiceDays) {
                ...
                const deletedServices = await this.executeWithRetry(() => drizzle.mcpService?.deleteMany({
                    where: {

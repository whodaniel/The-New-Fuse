...
import type { Agent, AgentCapabilityDiscovery, AgentCollaboration, AgentMCPEndpoint, AgentMessageResult, AgentMessageRouting, AgentRegistrationResult, IMCPAgentIntegration } from '../interfaces/IMCPAgentIntegration.js';
 ...
 */
export declare class MCPAgentIntegration extends EventEmitter implements IMCPAgentIntegration {
    private config;
    private broker;
    private client;

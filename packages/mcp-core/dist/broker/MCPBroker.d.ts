...
import { BrokerConfig, MCPServiceInfo, RoutingMetrics, ServiceCompatibilityResult, ServiceHealth, ServiceQuery } from '../types/index.js';
...
export declare class MCPBroker extends EventEmitter implements IMCPBroker {
     ...
     */
    subscribeToEvents(serviceId: string, pattern: string, patternType?: PatternType, filters?: Record<string, unknown>, metadata?: Record<string, unknown>): Promise<string>;
    /**
     ...
     */
    getEventSubscriptionStatistics(): import("./EventSubscriptionManager.js").SubscriptionStats;
    /**

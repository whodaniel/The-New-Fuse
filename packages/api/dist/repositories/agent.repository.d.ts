...
declare const agents: import("drizzle-orm/pg-core/table", { with: { "resolution-mode": "require" } }).PgTableWithColumns<{
    ...
    columns: {
        ...
        workerAction: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
            name: "role";
            tableName: "agents";
            dataType: "string";
            columnType: "PgEnumColumn";
        ...
        daccRole: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
            name: "dacc_role";
            tableName: "agents";
            dataType: "string";
            columnType: "PgEnumColumn";
        ...
        canonicalEntityId: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
        ...
        idNumber: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
            name: "id_number";
            tableName: "agents";
            dataType: "string";
            columnType: "PgVarchar";
        ...
        federation: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
            name: "federation";
            tableName: "agents";
            dataType: "json";
            columnType: "PgJsonb";
        ...
        fulfillment: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
            name: "fulfillment";
            tableName: "agents";
            dataType: "json";
            columnType: "PgJsonb";
        ...
        traits: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{
            name: "traits";
            tableName: "agents";
            dataType: "json";
            columnType: "PgJsonb";
        ...
        fulfillmentUpdatedAt: import("drizzle-orm/pg-core", { with: { "resolution-mode": "require" } }).PgColumn<{

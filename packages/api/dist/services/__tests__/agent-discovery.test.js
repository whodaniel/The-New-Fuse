...
import { AgentStatus, } from '../../types/agent-discovery.types.js';
describe('Agent Discovery System', () => {
    ...
    describe('Capability Matching', () => {
        ...
        it('should find capability matches with semantic search', () => {
            const matches = matcher.findCapabilityMatches(agents, 'review code', {
                minScore: 0.5,
            });
        ...
        it('should boost scores for language matches', () => {
            const matches = matcher.findCapabilityMatches(agents, 'review Python code', {
                minScore: 0.5,
            });
            expect(matches.length).toBeGreaterThan(0);
        ...
        it('should filter by minimum score', () => {
            const matches = matcher.findCapabilityMatches(agents, 'unrelated query', {
                minScore: 0.8,
            });
    ...
    describe('Capability Composition', () => {
        ...
        it('should compose capabilities across agents', () => {
            const compositions = matcher.composeCapabilities(['data-cleaning', 'statistical-analysis'], agents);
        ...
        it('should score compositions based on reliability', () => {
            const compositions = matcher.composeCapabilities(['data-cleaning', 'statistical-analysis'], agents, { preferReliable: true });
            expect(compositions[0].reliability).toBeCloseTo(0.95 * 0.93, 2);
        });
    });
});
//# sourceMappingURL=agent-discovery.test.js.map
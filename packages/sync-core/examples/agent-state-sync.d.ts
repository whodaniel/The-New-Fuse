...
export declare class AgentCoordinationService {
     ...
     */
    updateAgentStatus(agentId: string, status: AgentState['status'], metadata?: AgentState['metadata']): Promise<void>;
    /**
     ...
     */
    updateTaskProgress(agentId: string, taskId: string, progress: number, tenantId: string): Promise<void>;
    /**

...
export declare class RealTimeNotificationService implements OnModuleInit {
     ...
     */
    broadcastSystemNotification(title: string, message: string, priority?: Notification['priority']): Promise<void>;
    /**
     * Send notification to specific tenant
     */
    notifyTenant(tenantId: string, title: string, message: string, type?: Notification['type']): Promise<void>;
    /**
     * Send notification to specific user
     */
    notifyUser(userId: string, tenantId: string, title: string, message: string, type?: Notification['type']): Promise<void>;
    /**

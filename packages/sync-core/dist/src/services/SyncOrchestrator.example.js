...
exports.SyncErrorHandler = exports.DocumentService = exports.SyncOrchestratorExamples = void 0;
// Example: Setting up SyncOrchestrator in a NestJS module
class SyncOrchestratorExamples {
     ...
     */
    async syncGlobalPromptTemplates() {
        const templates = [
            {
                id: 'template-1',
...
{{focus_areas}}`,
    ...
    async syncTaskUpdates() {
        ...
        try {
            ...
            await this.syncOrchestrator.syncTenantData('user-123', // tenant ID (user ID in this case)
            'task', taskData);
     ...
     */
    async syncWorkflowStateChanges() {
        const workflowData = {
            id: 'workflow-101',
    ...
    async performBulkSync() {
        ...
        try {
            ...
            const syncPromises = agents.map((agent) => this.syncOrchestrator.syncTenantData(tenantId, 'agent', agent));
...
- Error codes`,
     ...
     */
    async syncCollaborativeSession() {
        const sessionData = {
            id: 'collab-session-1',
        ...
        try {
            ...
            for (const participantId of sessionData.participants) {
                await this.syncOrchestrator.syncTenantData(participantId, 'config', // Using config type for session data
                sessionData);
            }
...
exports.SyncOrchestratorExamples = SyncOrchestratorExamples;
/**
...
class DocumentService {
    ...
    async updateDocument(documentId, userId, changes) {
...
class SyncErrorHandler {
    ...
    async handleSyncWithRetry(operation, maxRetries = 3) {
        let lastError;
...
//# sourceMappingURL=SyncOrchestrator.example.js.map
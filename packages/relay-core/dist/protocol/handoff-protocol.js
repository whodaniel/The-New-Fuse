...
exports.TNFResourcePointer = zod_1.z.object({
    uri: zod_1.z
        .string()
        .url()
        .or(zod_1.z.string().regex(/^(pgvector|file|trp|s3|r2):\/\//)),
...
exports.HandoffPayload = zod_1.z.object({
    ...
    resourcePointers: zod_1.z.record(zod_1.z.string(), exports.TNFResourcePointer).optional(),
    twipRef: zod_1.z
        .object({

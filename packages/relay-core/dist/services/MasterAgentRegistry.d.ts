...
import { VCIssuanceService } from './VCIssuanceService.js';
...
export declare class MasterAgentRegistry extends EventEmitter {
    ...
    private fairtableAdapters;
    private spreadsheetRowMap;
    ...
    private spreadsheetSyncInterval?;
    ...
    private loadFairtableAdapters;
    private buildLegacySpreadsheetData;
    private toLegacyPriority;
    private rebuildSpreadsheetSnapshot;
    /**
     ...
     * Default: 24 hours
     */
    pruneInactiveAgents(maxAgeMs?: number): number;

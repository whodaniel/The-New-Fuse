 ...
 */
import { BigNumberish, JsonRpcProvider, TransactionReceipt, Wallet, ethers } from 'ethers';
...
export declare class BlockchainService extends EventEmitter {
     ...
     */
    createTokenBoundAccount(tokenId: number, registryAddress?: string, implementationAddress?: string, salt?: number): Promise<string>;
    /**

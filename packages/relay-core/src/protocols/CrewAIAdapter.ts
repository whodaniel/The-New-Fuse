...
export class CrewAIAdapter implements ProtocolAdapter {
  ...
  private crewaiToA2A(message: RelayMessage): RelayMessage {
  ...
  private a2aToCrewAI(message: RelayMessage): RelayMessage {
    const { payload } = message;
  ...
  private isCrewAITaskExecution(payload: any): boolean {
    return !!(payload.task || payload.task_id) && !!(payload.agent || payload.agent_role);
  }

  private isCrewAICrewCoordination(payload: any): boolean {
  ...
  private isCrewAIMemorySharing(payload: any): boolean {
  ...
  private createCrewAITaskExecution(payload: any): any {
    return {
  ...
  private createCrewAICrewCoordination(payload: any): any {
    return {
  ...
  private createCrewAIAgentCollaboration(payload: any): any {
    return {
  ...
  private createCrewAIToolUsage(payload: any): any {
    return {
  ...
  private createCrewAIMemorySharing(payload: any): any {
    return {
  ...
  private createCrewAIMessage(payload: any): any {
    return {

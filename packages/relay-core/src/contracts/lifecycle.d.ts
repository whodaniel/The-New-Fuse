...
export declare function toWorkflowDefinitionStatusTarget(input: string | null | undefined, target: 'normalized' | 'api' | 'engine'): string | null;
export declare function toWorkflowExecutionStatusTarget(input: string | null | undefined, target: 'normalized' | 'api' | 'engine'): string | null;

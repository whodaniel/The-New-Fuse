...
department: tech
description:
  Sync TNF reliability and self-improvement audit loops with master clock cron
  protocols, including schedule mapping, trigger contracts, escalation paths,
  and verification checks. Use when Codex must operationalize or harden
  scheduled TNF loops beyond ad hoc CI triggers.
---

...
department: tech
description:
  Reference for Kilo CLI and interactive commands. Use this skill when
  leveraging Kilo for coding tasks or connecting to its 500+ supported LLM
  models.
---
...
- `/connect`: Opens the interface to authenticate with AI providers (Minimax,
  GLM, etc.).
...
Use `tmux new-session -d -s kilo 'kilo'` to run Kilo in the background for

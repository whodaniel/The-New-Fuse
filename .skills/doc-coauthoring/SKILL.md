...
**If no integrations are detected and in Claude.ai or Claude app:** Suggest they
can enable connectors in their Claude settings to allow pulling context from
...
**Goal:** Test the document with a fresh Claude (no context bleed) to verify it
works for readers.
...
would they type into Claude.ai?
...
When Reader Claude consistently answers questions correctly and doesn't surface

...
operations. Performance varies by client—some clients benefit from code
...
- [⚡ TypeScript Guide](./reference/node_mcp_server.md) - TypeScript patterns
  and examples
...
- [🐍 Python Guide](./reference/python_mcp_server.md) - Python patterns and
  examples

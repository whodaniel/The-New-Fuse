...
department: tech
description:
  Reference for OpenClaw gateway commands and OAuth interactive slash commands.
  Use this when managing multi-channel routing or authenticating agents with
...
- `openclaw --dev gateway`: Start a development instance of the OpenClaw
  gateway.
...
- `/oauth-provider-matrix`: Displays the status and health of all configured
  OAuth providers.

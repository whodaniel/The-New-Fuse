...
description: Imported wrapper for nexus-orchestrator-qa-agent
source_agent: .claude/agents/nexus-orchestrator-qa-agent.md
---

# nexus-orchestrator-qa-agent

This skill is a provider-neutral wrapper for the canonical Claude agent
definition at `.claude/agents/nexus-orchestrator-qa-agent.md`.

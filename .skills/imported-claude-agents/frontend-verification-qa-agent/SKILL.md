...
description: Imported wrapper for frontend-verification-qa-agent
source_agent: .claude/agents/frontend-verification-qa-agent.md
---

# frontend-verification-qa-agent

This skill is a provider-neutral wrapper for the canonical Claude agent
definition at `.claude/agents/frontend-verification-qa-agent.md`.

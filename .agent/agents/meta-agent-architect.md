...
description: Expert agent architect. Use this to design and generate the complete
  Claude Code `.md` file for a new Sub-Agent based on a user's high-level description.
color: Cyan
---

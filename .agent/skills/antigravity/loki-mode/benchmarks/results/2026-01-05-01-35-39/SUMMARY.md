...
```bash
python -m swebench.harness.run_evaluation     --predictions $HOME/git/loki-mode/benchmarks/results/2026-01-05-01-35-39/swebench-predictions.json     --max_workers 4
```

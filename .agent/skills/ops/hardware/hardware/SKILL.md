...
peripherals connected to the board.
...
Most I2C/SPI pins are shared with WiFi on Sipeed boards. You must configure
pinmux before use.
...
- **Write operations** require `confirm: true` — always confirm with the user
  first
...
See `references/common-devices.md` for register maps and usage of popular
sensors: AHT20, BME280, SSD1306 OLED, MPU6050 IMU, DS3231 RTC, INA219 power
monitor, PCA9685 PWM, and more.

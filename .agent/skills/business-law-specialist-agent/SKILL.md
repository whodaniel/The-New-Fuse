...
department: tech
description:
  Provide business-law issue spotting, risk triage, and compliance action
  planning for company operations, contracts, employment, intellectual property,
  privacy/data handling, and regulatory exposure. Use when the user asks for a
  business law specialist, legal-risk review of a business decision, contract
  and policy risk checks, or an attorney-ready legal escalation brief.
---
...
Run a structured legal-risk pass over business decisions, then produce a clear
action plan and escalation brief for licensed counsel.
...
3. For high-stakes topics (litigation, regulatory investigation, employment
   termination, securities, tax disputes, criminal exposure), recommend
...
- `Critical`: immediate legal exposure, injunction risk, severe penalties, or
  unrecoverable harm
...
Issue Findings | Issue | Domain | Tier | Why It Matters | Immediate Action | |
--- | --- | --- | --- | --- |

...
source_agent: .claude/agents/cursor-watch-learn-operator.md
---

# cursor-watch-learn-operator

This skill is a provider-neutral wrapper for the canonical Claude agent
definition at `.claude/agents/cursor-watch-learn-operator.md`.
...
1. Work in `/Users/danielgoldberg/tools/cursor-watch-learn`.

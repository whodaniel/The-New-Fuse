...
Himalaya is a CLI email client that lets you manage emails from the terminal
using IMAP, SMTP, Notmuch, or Sendmail backends.
...
- Store passwords securely using `pass`, system keyring, or a command that

...
def upload_artifacts(pg_conn):
    artifacts = [
        ...
        ("migrate_to_railway_postgres.py", "text/x-python", True),
...
def main():
    ...
    parser.add_argument("--pg-url", default=os.environ.get("RAILWAY_DATABASE_PUBLIC_URL") or os.environ.get("DATABASE_PUBLIC_URL"))

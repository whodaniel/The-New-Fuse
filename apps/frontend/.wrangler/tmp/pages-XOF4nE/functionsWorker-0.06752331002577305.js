...
async function onRequest(context) {
  ...
  const isAppDomain = !isLandingDomain;
  ...
  if (isLandingDomain) {
    ...
    const isLandingSpaRoute = landingSpaRoutes.includes(path) || path === "/legal/privacy" || path === "/legal/terms";
...
// ../.wrangler/tmp/pages-XOF4nE/functionsRoutes-0.8421570143385246.mjs
var routes = [
  {
    routePath: "/:path*",
    mountPath: "/",

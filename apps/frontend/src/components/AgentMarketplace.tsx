      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <Input
            ...
            min={listing.currentBid ? listing.currentBid + 1 : listing.price}
            step={1}
          />
        </div>
      ...
      setListings(
        listings.map((listing) =>
          listing.id === selectedListing.id
            ? Object.assign(Object.assign({}, listing), { currentBid: amount })
            : listing
        )
      );
    } catch (error) {
            ...
            <CardContent>
              ...
              <div className="flex justify-between items-center">
                ...
                {listing.isAuction ? (
                  ...
                  <Button onClick={() => handlePurchase(listing)} disabled={isLoading}>
                    Purchase
                  </Button>
                )}
              </div>

    ...
    >
      <div className="h-full px-4 sm:px-3 lg:px-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <button
            onClick={onMenuClick}
            className="lg:hidden p-2 text-gray-400 hover:text-white rounded-md hover:bg-transparent/5 transition-colors"
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center border-2 border-slate-800 shadow-none cursor-pointer hover:scale-105 transition-transform">
              ...
              {isUserMenuOpen && (
                <>
                  ...
                  ></div>
                  <div className="absolute right-0 mt-2 w-48 bg-[#1e293b] border border-white/10 rounded-md shadow-none py-1 z-20 animate-in fade-in slide-in-from-top-2 duration-200">
                    ...
                    <Link
                      to="/user/profile"
                      className="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-transparent/5 hover:text-white"
                      onClick={() => setIsUserMenuOpen(false)}
                    >
                    ...
                    <button
                      ...
                      className="w-full flex items-center px-4 py-2 text-sm text-red-400 hover:bg-transparent/5 hover:text-red-300 text-left"
                    >

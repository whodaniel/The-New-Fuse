...
class System {
  ...
  static async getEmbeddingSettings() {
    try {
      const response = await authFetch('/api/system/embedding-settings', {
        method: 'GET',
        headers: {
  ...
  static async checkEmbeddingProvider(settings: any) {
    try {
      const response = await authFetch('/api/system/check-embedding-provider', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  static async getModels(settings: any) {
    try {
      const response = await authFetch('/api/system/embedding-models', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  static async hasEmbeddings() {
    try {
      const response = await authFetch('/api/system/has-embeddings', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  static async hasCachedEmbeddings() {
    try {
      const response = await authFetch('/api/system/has-cached-embeddings', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  static async fetchCanViewChatHistory() {
    try {
      const response = await authFetch('/api/system/chat-history-settings', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },

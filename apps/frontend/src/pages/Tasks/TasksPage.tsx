      ...
      <GlassCard className="p-4">
        <div className="flex flex-col md:flex-row gap-4 mb-4">
          ...
          <div className="flex gap-2 flex-wrap items-center">
            ...
            <div className="bg-transparent/5 rounded-md p-1 flex border border-white/10 h-12 items-center">
              <IconButton
                icon={List}
        ...
        <GlassCard className="overflow-hidden p-0">
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-transparent/5 border-b border-white/10">
                <tr>
              ...
              <tbody className="divide-y divide-white/5">
                {sortedTasks.map((task, index) => (
                  <motion.tr
                    key={task.id}
                    className="hover:bg-transparent/5 transition-colors group"
                  ...
                  >
                    ...
                    <td className="px-3 py-2 whitespace-nowrap">{getStatusBadge(task.status)}</td>
                    ...
                    <td className="px-3 py-2 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        <div className="w-24 bg-transparent/10 rounded-full h-1.5">
                          <div
        ...
        <div className="flex md:grid md:grid-cols-4 gap-4 overflow-x-auto pb-4 h-[calc(100vh-280px)] snap-x snap-mandatory md:snap-none">
          {(['pending', 'in-progress', 'completed', 'cancelled'] as const).map((status) => {
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between p-2 rounded-md bg-transparent/5 border border-white/10">
                ...
                <div className="flex flex-col gap-3 h-full">
                  <AnimatePresence>
                    {statusTasks.map((task, index) => (
                      ...
                      >
                        <GlassCard
                          className="p-4 hover:border-blue-500/50 transition-colors cursor-pointer group hover:bg-transparent/10"
                        ...
                        >
                          ...
                          <div className="mt-3">
                            <div className="w-full bg-transparent/10 rounded-full h-1">
                              <div

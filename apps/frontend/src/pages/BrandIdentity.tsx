      ...
      <main className="pt-32 pb-20 px-4 sm:px-3 lg:px-8 max-w-7xl mx-auto">
        ...
        <section className="mb-32">
          <div className="flex items-center gap-4 mb-10">
            <div className="w-12 h-12 rounded-md bg-blue-500/10 flex items-center justify-center text-blue-400">
              <Rocket className="w-6 h-6" />
            </div>
            <div>
              <h2 className="text-2xl font-bold text-white">Logo Concepts</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {/* Concept 1 */}
            <Card className="bg-transparent/5 border-white/10 backdrop-blur-xl hover:border-blue-500/50 transition-all duration-300">
            ...
            {/* Concept 2 */}
            <Card className="bg-transparent/5 border-white/10 backdrop-blur-xl hover:border-purple-500/50 transition-all duration-300">
              <CardContent className="p-0">
                <div className="aspect-square bg-black relative overflow-hidden rounded-t-lg group">
                  <img
            ...
            {/* Concept 3 */}
            <Card className="bg-transparent/5 border-white/10 backdrop-blur-xl hover:border-green-500/50 transition-all duration-300">
              <CardContent className="p-0">
                <div className="aspect-square bg-black relative overflow-hidden rounded-t-lg group">
                  <img
        ...
        <section className="mb-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="space-y-4">
              <div className="h-32 rounded-md bg-slate-950 border border-white/10 shadow-none relative overflow-hidden group">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Primary Background</p>
              </div>
            </div>

            <div className="space-y-4">
              <div className="h-32 rounded-md bg-blue-600 shadow-none shadow-blue-500/20 relative overflow-hidden group">
            ...
            <div className="space-y-4">
              <div className="h-32 rounded-md bg-purple-600 shadow-none shadow-purple-500/20 relative overflow-hidden group">
                <span className="absolute bottom-4 left-4 font-mono text-xs text-white/80 bg-black/20 px-2 py-1 rounded">
                  #a855f7
                </span>
              </div>
            ...
            <div className="space-y-4">
              <div className="h-32 rounded-md bg-pink-500 shadow-none shadow-pink-500/20 relative overflow-hidden group">
                <span className="absolute bottom-4 left-4 font-mono text-xs text-white/80 bg-black/20 px-2 py-1 rounded">
                  #ec4899
                </span>
              </div>
          ...
          <div className="mt-12 p-4 rounded-3xl bg-transparent/5 border border-white/10 backdrop-blur-xl">
          ...
          <div className="mt-12 p-4 rounded-3xl bg-transparent/5 border border-white/10 backdrop-blur-xl">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-emerald-100 p-4 rounded-md flex items-center gap-3">
              ...
              <div className="bg-violet-100 p-4 rounded-md flex items-center gap-3">
              ...
              <div className="bg-amber-100 p-4 rounded-md flex items-center gap-3">
        ...
        <section className="mb-32">
          <div className="flex items-center gap-4 mb-10">
            <div className="w-12 h-12 rounded-md bg-green-500/10 flex items-center justify-center text-green-400">
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div>
                ...
                <div className="p-4 rounded-3xl bg-transparent/5 border border-white/10 backdrop-blur-xl">
        ...
        <section>
          <div className="flex items-center gap-4 mb-10">
            <div className="w-12 h-12 rounded-md bg-orange-500/10 flex items-center justify-center text-orange-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="bg-transparent/5 border-white/10 backdrop-blur-xl">
            ...
            <Card className="bg-transparent/5 border-white/10 backdrop-blur-xl opacity-60">
              <CardContent className="p-4">
                ...
                <ul className="space-y-4">
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">Boring corporate jargon.</p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-red-500 text-lg">✗</span>
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">Generic and passive.</p>
                    </div>
                  </li>
                  <li className="flex gap-3">
                    <span className="text-red-500 text-lg">✗</span>
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">Weak Call to Action.</p>
                    </div>
                  </li>
                </ul>
              </CardContent>

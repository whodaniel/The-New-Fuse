...
const VISUALIZATION_SECTIONS: VisualizationSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Word / Term Frequency Report',
        description:
          'Paginated corpus term-frequency report generated by the semantic pipeline and published next to the unified graph explorer.',
        href: '/visualizations/semantic/wordcount_report.html',
        tags: ['Semantic', 'Concordance'],
        status: 'stable',
        integration: 'static-html',
      },
    ],

...
export const UnifiedAgentCreator: React.FC = () => {
        ...
        {[
          ...
          return (
            <div
              ...
              className={`p-4 rounded-md border cursor-pointer transition-all flex items-center gap-4 ${
                isActive
                  ? 'border-blue-500 bg-blue-500/20'
                  : 'border-white/10 hover:border-white/30'
              }`}
            >
              <div className={`p-3 rounded-md bg-transparent/5 ${tool.color}`}>
  ...
  const renderStep3 = () => (
    <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
      ...
      <GlassCard className="p-4 space-y-8">
        <div className="flex items-center justify-between">
          ...
          >
            <div
              className={`w-6 h-6 rounded-full bg-transparent transition-transform ${
  ...
  return (
    <div className="min-h-screen bg-transparent px-3 py-16">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <GlassCard className="p-12 rounded-[3rem] border-white/10 shadow-none relative overflow-hidden">

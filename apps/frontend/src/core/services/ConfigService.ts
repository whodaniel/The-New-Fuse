...
export class ConfigService {
  ...
  isFeatureEnabled(featureKey) {
    var _a, _b;
    return (
      ((_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.features) === null ||
      _b === void 0
        ? void 0
        : _b[featureKey]) || false
    );
  ...
  getSetting(key, defaultValue) {
    var _a, _b, _c;
    return (_c =
      (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.settings) === null ||
      _b === void 0
        ? void 0
  ...
  async updateSetting(key, value) {
    try {
      ...
      if (this.config) {
        this.config.settings = Object.assign(Object.assign({}, this.config.settings), {
          [key]: value,
        });
  ...
  isDevelopment() {
    var _a;
    return (
      ((_a = this.config) === null || _a === void 0 ? void 0 : _a.environment) === 'development'
    );
  }
  isStaging() {
    var _a;
  ...
  isProduction() {
    var _a;
    return (
      ((_a = this.config) === null || _a === void 0 ? void 0 : _a.environment) === 'production'
    );
  }
  getVersion() {
    var _a;

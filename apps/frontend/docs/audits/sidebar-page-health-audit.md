...
- `/admin/system-metrics` -> target `/admin/system-metrics` ->
  `pages/Admin/SystemMetricsDashboard.tsx` | status: `working` | risk: 2 | hits:
  fallback_demo:1
...
- `/timeline` -> target `/timeline` -> `pages/Timeline/index.tsx` | status:
  `working` | risk: 2 | hits: fallback_demo:1
- `/workflows/nexus` -> target `/workflows/nexus` -> `pages/SynapticNexus.tsx` |
  status: `working` | risk: 2 | hits: randomized_behavior:1
- `/workflows/nexus?layer=lexicon` -> target `/workflows/nexus` ->
  `pages/SynapticNexus.tsx` | status: `working` | risk: 2 | hits:
  randomized_behavior:1
- `/workflows/nexus?layer=memory` -> target `/workflows/nexus` ->
  `pages/SynapticNexus.tsx` | status: `working` | risk: 2 | hits:
  randomized_behavior:1
- `/workflows/nexus?layer=topology&from=observatory` -> target
  `/workflows/nexus` -> `pages/SynapticNexus.tsx` | status: `working` | risk: 2
  | hits: randomized_behavior:1
...
- `/admin/settings` -> target `/admin/settings` ->
  `pages/Admin/AdminSettings.tsx` | status: `working` | risk: 1 | hits:
  timeout_simulation:1
- `/workflows` -> target `/workflows` -> `pages/Workflows.tsx` | status:
  `working` | risk: 1 | hits: timeout_simulation:1
- `/workspace/projects` -> target `/workspace/projects` ->
  `pages/Projects/ProjectView.tsx` | status: `working` | risk: 1 | hits:
  timeout_simulation:1
- `/admin/agent-management` -> target `/admin/agent-management` ->
  `pages/Admin/AgentManagementFull.tsx` | status: `working` | risk: 0 | hits:
  none
...
- `/admin/api-analytics` -> target `/admin/api-analytics` ->
  `pages/Admin/APIAnalyticsFull.tsx` | status: `working` | risk: 0 | hits: none
- `/admin/audit-logs` -> target `/admin/audit-logs` ->
  `pages/Admin/AuditLogViewer.tsx` | status: `working` | risk: 0 | hits: none
...
- `/admin/layout` -> target `/admin/layout` ->
  `pages/Admin/AdminLayoutConfigurator.tsx` | status: `working` | risk: 0 |
  hits: none
...
- `/admin/port-management` -> target `/admin/port-management` ->
  `pages/Admin/PortManagement.tsx` | status: `working` | risk: 0 | hits: none
...
- `/admin/user-management` -> target `/admin/user-management` ->
  `pages/Admin/UserManagementFull.tsx` | status: `working` | risk: 0 | hits:
  none
...
- `/admin/workspaces` -> target `/admin/workspaces` ->
  `pages/Admin/WorkspaceManagement.tsx` | status: `working` | risk: 0 | hits:
  none
...
- `/dashboard` -> target `/dashboard` ->
  `pages/dashboard/TNFConsoleDashboard.tsx` | status: `working` | risk: 0 |
  hits: none

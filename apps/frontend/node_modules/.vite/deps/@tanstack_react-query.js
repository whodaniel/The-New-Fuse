...
var QueriesObserver = (_a10 = class extends Subscribable {
  ...
  return __privateGet(this, _options)?.combine !== void 0 && __privateGet(this, _observers2).some((observer, index) => {
    return observer.options.suspense && __privateGet(this, _result)[index]?.data === void 0;
  });
  ...
  if (this.hasListeners()) {
    ...
    const newResult = shouldSkipCombine ? previousResult : __privateMethod(this, _QueriesObserver_instances, combineResult_fn).call(this, newTracked, __privateGet(this, _options)?.combine);

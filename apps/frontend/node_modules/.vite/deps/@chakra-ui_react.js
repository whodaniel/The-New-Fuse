...
import {
  ...
  require_prop_types
} from "./chunk-L2ON3CCV.js";
import {
  _extends
} from "./chunk-76MSRD5V.js";
import {
  __assign,
  __rest,
  __spreadArray
} from "./chunk-X25FLHTA.js";
import {
  isPropValid,
  memoize
} from "./chunk-W4HXVUCK.js";
import {
  AnimatePresence,
  motion,
  useIsPresent,
  usePresence
} from "./chunk-FXILB6ES.js";
import {
  require_jsx_runtime
} from "./chunk-64WYBL6Q.js";
import {
  require_react_dom
} from "./chunk-N2Q4LUGP.js";
import {
  require_react
} from "./chunk-DB3BP4D4.js";
import {
  __commonJS,
  __toESM,
  require_dist,
...
var require_react_is_production_min = __commonJS({
  "../../node_modules/hoist-non-react-statics/node_modules/react-is/cjs/react-is.production.min.js"(exports) {
    ...
    var t2 = b ? /* @__PURE__ */ Symbol.for("react.lazy") : 60116;
    ...
    exports.isValidElementType = function(a) {
      return "string" === typeof a || "function" === typeof a || a === e || a === m || a === g || a === f || a === p || a === q || "object" === typeof a && null !== a && (a.$$typeof === t2 || a.$$typeof === r2 || a.$$typeof === h || a.$$typeof === k || a.$$typeof === n || a.$$typeof === w || a.$$typeof === x || a.$$typeof === y || a.$$typeof === v);
    };
    exports.typeOf = z;
  }
});
...
// ../../node_modules/@chakra-ui/hooks/dist/esm/index.mjs
...
function getOwnerWindow(node3) {
  return getOwnerDocument(node3)?.defaultView ?? window;
}
function getOwnerDocument(node3) {
  return isHTMLElement2(node3) ? node3.ownerDocument : document;
}
...
// ../../node_modules/@chakra-ui/utils/dist/esm/contains.mjs
...
function isFocusable(element) {
  if (!isHTMLElement2(element) || isHiddenElement(element) || isDisabledElement(element)) {
    return false;
  }
...
function useCallbackRef(callback, deps = []) {
  ...
  return (0, import_react3.useCallback)((...args) => callbackRef.current?.(...args), deps);
}
...
function useCounter(props = {}) {
  ...
  const update = (0, import_react10.useCallback)(
    (next2) => {
      ...
      onChangeProp?.(next2.toString(), parse(next2));
    },
  ...
  const reset = (0, import_react10.useCallback)(() => {
    ...
    if (defaultValue == null) {
      ...
      next2 = cast(defaultValue, stepProp, precisionProp) ?? min;
    }
    update(next2);
...
var useSafeLayoutEffect = Boolean(globalThis?.document) ? import_react12.useLayoutEffect : import_react12.useEffect;
...
function getOwnerDocument2(node3) {
  return node3?.ownerDocument ?? document;
}
...
var useSafeLayoutEffect2 = Boolean(globalThis?.document) ? import_react21.useLayoutEffect : import_react21.useEffect;
...
var PanEvent = class {
  constructor(event, handlers2, threshold) {
    ...
    __publicField(this, "updatePoint", () => {
      ...
      if (!isPanStarted) {
        onStart?.(this.lastEvent, info2);
        this.startEvent = this.lastEvent;
      }
      onMove?.(this.lastEvent, info2);
    });
...
// ../../node_modules/@chakra-ui/styled-system/dist/esm/index.mjs
...
function getCSSVar(theme2, scale2, value) {
  return theme2.__cssMap?.[`${scale2}.${value}`]?.varRef ?? value;
}
...
// ../../node_modules/@chakra-ui/anatomy/dist/esm/index.mjs
...
// ../../node_modules/@chakra-ui/theme-tools/dist/esm/index.mjs
...
function getBreakpointValue(theme2, value, fallback) {
  if (value == null)
    return value;
  const getValue = (val) => theme2.__breakpoints?.asArray?.[val];
  return getValue(value) ?? getValue(fallback) ?? fallback;
}
function getTokenValue(theme2, value, fallback) {
  if (value == null)
    return value;
  const getValue = (val) => theme2.__cssMap?.[val]?.value;
  return getValue(value) ?? getValue(fallback) ?? fallback;
}
    ...
    Alert,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime16.jsxs)(chakra.div, { flex: "1", maxWidth: "100%", children: [
          title && (0, import_jsx_runtime16.jsx)(AlertTitle, { id: ids?.title, children: title }),
          description && (0, import_jsx_runtime16.jsx)(AlertDescription, { id: ids?.description, display: "block", children: description })
        ] }),
...
var DefaultPortal = (props) => {
  ...
  const _children = manager?.zIndex ? (0, import_jsx_runtime17.jsx)(Container, { zIndex: manager?.zIndex, children }) : children;
...
var ContainerPortal = (props) => {
  ...
  const portal = (0, import_react42.useMemo)(() => {
    const node3 = containerEl?.ownerDocument.createElement("div");
    if (node3)
...
var createProvider = (providerTheme) => {
  return function ChakraProvider2({
    ...
    return (0, import_jsx_runtime19.jsxs)(Provider, { theme: theme2, ...restProps, children: [
      (0, import_jsx_runtime19.jsx)(ToastOptionProvider, { value: toastOptions?.defaultOptions, children }),
...
var DescendantsManager = class {
  constructor() {
    ...
    __publicField2(this, "indexOf", (node3) => {
      if (!node3)
        return -1;
      return this.descendants.get(node3)?.index ?? -1;
    });
...
var variants13 = {
  exit: ({
    ...
    transition: transition3?.exit ?? withDelay.exit(defaultTransitions.exit, delay)
  }),
  enter: ({
    animateOpacity,
    endingHeight,
    ...
    transition: transition3?.enter ?? withDelay.enter(defaultTransitions.enter, delay)
  })
};
...
function AvatarName(props) {
  ...
  return (0, import_jsx_runtime27.jsx)(chakra.div, { role: "img", "aria-label": name, ...rest, __css: styles2.label, children: name ? getInitials?.(name) : null });
}
...
var Button = forwardRef4((props, ref) => {
  ...
  const buttonStyles = (0, import_react60.useMemo)(() => {
    const _focus = { ...styles2?.["_focus"], zIndex: 1 };
    return {
      display: "inline-flex",
      appearance: "none",
      alignItems: "center",
...
function useFormControlProps(props) {
  ...
  return {
    ...
    onFocus: callAllHandlers(field?.onFocus, onFocus3),
    onBlur: callAllHandlers(field?.onBlur, onBlur3)
  };
}
...
var restoreFocusTo = function(location) {
  ...
  for (var _i = 0, stack_1 = stack; _i < stack_1.length; _i++) {
    ...
    if (parent_1 && ownerDocument.contains(parent_1)) {
      var left = (_b = line2.left) === null || _b === void 0 ? void 0 : _b.call(line2);
      var savedCurrent = line2.current();
      var current = parent_1.contains(savedCurrent) ? savedCurrent : void 0;
      var right = (_c = line2.right) === null || _c === void 0 ? void 0 : _c.call(line2);
...
var getBreakpoint = (theme2, value) => {
  return theme2?.breakpoints?.[value] ?? value;
};
...
function useBreakpoint(arg) {
  ...
  return breakpoints3[index]?.breakpoint ?? opts.fallback;
}
...
function useBreakpointValue(values, arg) {
  ...
  if (!breakpoint)
    return;
  const breakpoints3 = Array.from(theme2.__breakpoints?.keys || []);
...
var setArrowStyles = (state2) => {
  ...
  if (state2.elements?.arrow && overrides) {
...
function usePopper(props = {}) {
  ...
  const reference = (0, import_react93.useRef)(null);
  const popper = (0, import_react93.useRef)(null);
...
function useMenu(props = {}) {
  ...
  const refocus = (0, import_react96.useCallback)(() => {
    ...
    const hasFocusWithin2 = menuRef.current?.contains(doc.activeElement);
    const shouldRefocus = isOpen && !hasFocusWithin2;
    if (!shouldRefocus)
      return;
    const node3 = descendants.item(focusedIndex)?.node;
    node3?.focus({ preventScroll: !scrollIntoViewRef.current });
...
function isTargetMenuItem(target) {
  return isHTMLElement3(target) && !!target?.getAttribute("role")?.startsWith("menuitem");
}
...
var MenuList = forwardRef4(
  function MenuList2(props, ref) {
    ...
    return (0, import_jsx_runtime96.jsx)(
      ...
      {
        ...positionerProps,
        __css: { zIndex: props.zIndex ?? styles2.list?.zIndex },
...
var variants14 = {
  initial: ({ offsetX, offsetY, transition: transition3, transitionEnd, delay }) => ({
    ...
    x: offsetX,
    y: offsetY,
    transition: transition3?.exit ?? withDelay.exit(TRANSITION_DEFAULTS.exit, delay),
    transitionEnd: transitionEnd?.exit
  }),
  enter: ({ transition: transition3, transitionEnd, delay }) => ({
    ...
    x: 0,
    y: 0,
    transition: transition3?.enter ?? withDelay.enter(TRANSITION_DEFAULTS.enter, delay),
    transitionEnd: transitionEnd?.enter
  }),
...
function getDrawerPlacement(placement, dir) {
  if (!placement)
    return;
  return placementMap2[placement]?.[dir] ?? placement;
}
function Drawer(props) {
  ...
  const theme2 = useTheme2();
  const drawerStyleConfig = theme2.components?.Drawer;
...
var variants17 = {
  exit: ({ direction: direction2, transition: transition3, transitionEnd, delay }) => {
    ...
    return {
      ...exitStyles,
      transition: transition3?.exit ?? withDelay.exit(defaultTransition.exit, delay),
      transitionEnd: transitionEnd?.exit
    };
  },
  enter: ({ direction: direction2, transitionEnd, transition: transition3, delay }) => {
    ...
    return {
      ...enterStyles,
      transition: transition3?.enter ?? withDelay.enter(defaultTransition.enter, delay),
      transitionEnd: transitionEnd?.enter
    };
  }
};
...
function useNumberInput(props = {}) {
  ...
  useUpdateEffect(() => {
    if (counter2.valueAsNumber > max) {
      onInvalid?.("rangeOverflow", format(counter2.value), counter2.valueAsNumber);
  ...
  const ariaValueText = (0, import_react112.useMemo)(() => {
    const text = getAriaValueText?.(counter2.value);
    if (text != null)
      return text;
...
var Progress = forwardRef4((props, ref) => {
  ...
  const borderRadius = propBorderRadius ?? styles2.track?.borderRadius;
...
var Radio = forwardRef4((props, ref) => {
  ...
  const {
    ...
    children,
    isDisabled = group?.isDisabled,
    isFocusable: isFocusable2 = group?.isFocusable,
...
function getToastPlacement(position3, dir) {
  ...
  return logical2?.[dir] ?? computedPosition;
}
...
function createToastFn(dir, defaultOptions3) {
  const normalizeToastOptions = (options) => ({
    ...
    position: getToastPlacement(
      options?.position ?? defaultOptions3?.position,
      dir
    )
  });
  const toast = (options) => {

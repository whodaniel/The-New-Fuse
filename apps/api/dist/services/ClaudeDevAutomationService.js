...
let ClaudeDevAutomationService = ClaudeDevAutomationService_1 = class ClaudeDevAutomationService {
    constructor() {
        this.logger = new common_1.Logger(ClaudeDevAutomationService_1.name);
     ...
     * Create agent batch
     */
    async createAgentBatch(tenantId, batchData) {
        // Mock implementation
        const agents = [];
...
//# sourceMappingURL=ClaudeDevAutomationService.js.map
...
export declare class ClaudeDevAutomationService {
     ...
     * Create a new agent
     */
    createAgent(tenantId: string, agentData: any): Promise<any>;
    /**
     ...
     * Get agent by ID
     */
    getAgent(agentId: string, tenantId?: string): Promise<any | null>;
    /**
     * Execute a task
     */
    executeTask(agentId: string, tenantId: string, taskData: any): Promise<any>;
    /**
     * Create agent batch
     */
    createAgentBatch(tenantId: string, batchData: any): Promise<any>;
    /**
     * Get tasks by agent ID
     */
    getTasksByAgent(agentId: string, tenantId?: string): Promise<AutomationResult[]>;
    getTasksByTenant(tenantId: string): Promise<AutomationResult[]>;
}

...
class ClaudeDevTemplateUtils {
    ...
    static getTemplateDocumentation(templateId) {
        const template = ClaudeDevTemplateRegistry.getTemplate(templateId);
        if (!template) {
...
//# sourceMappingURL=claude-dev-templates.js.map
...
let VectorStoreGrpcClient = VectorStoreGrpcClient_1 = class VectorStoreGrpcClient {
    constructor() {
        this.logger = new common_1.Logger(VectorStoreGrpcClient_1.name);
    ...
    async createCollection(request) {
        const createCollection = (0, node_util_1.promisify)(this.client.createCollection.bind(this.client));
        try {
    ...
    async deleteCollection(name) {
        const deleteCollection = (0, node_util_1.promisify)(this.client.deleteCollection.bind(this.client));
        try {
    ...
    async listCollections() {
        const listCollections = (0, node_util_1.promisify)(this.client.listCollections.bind(this.client));
        try {
    ...
    async upsertDocuments(request) {
        const upsertDocuments = (0, node_util_1.promisify)(this.client.upsertDocuments.bind(this.client));
        try {
    ...
    async getDocument(collection, id) {
        const getDocument = (0, node_util_1.promisify)(this.client.getDocument.bind(this.client));
        try {
    ...
    async similaritySearch(request) {
        const similaritySearch = (0, node_util_1.promisify)(this.client.similaritySearch.bind(this.client));
        try {
    ...
    // Health and Stats
    async healthCheck() {
        const healthCheck = (0, node_util_1.promisify)(this.client.healthCheck.bind(this.client));
        try {
    ...
    async getStats(collection) {
        const getStats = (0, node_util_1.promisify)(this.client.getStats.bind(this.client));
        try {

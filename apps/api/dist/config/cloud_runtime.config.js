...
exports.CloudRuntimeConfigService = void 0;
exports.validateCloudRuntimeEnvironment = validateCloudRuntimeEnvironment;
/**
 * CloudRuntime Environment Configuration
 * Handles CloudRuntime-specific environment variable parsing and configuration
 */
class CloudRuntimeConfigService {
...
function validateCloudRuntimeEnvironment() {
    ...
    for (const varConfig of requiredVars) {
        if (!process.env[varConfig.name]) {
            errors.push(`❌ Missing required CloudRuntime environment variable: ${varConfig.name} - ${varConfig.description}`);
        }
    }
    if (errors.length > 0) {
...
//# sourceMappingURL=cloud_runtime.config.js.map
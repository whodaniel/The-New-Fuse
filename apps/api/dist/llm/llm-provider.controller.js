...
let LLMProviderController = class LLMProviderController {
    ...
    async registerClaudeCodeCLI() {
        try {
            ...
            throw new common_1.HttpException(`Failed to register Claude Code CLI: ${error.message}`, common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async registerGeminiCLI() {
        try {
            ...
            throw new common_1.HttpException(`Failed to register Gemini CLI: ${error.message}`, common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
...
__decorate([
    ...
    (0, swagger_1.ApiBody)({ description: 'LLM Provider creation data' }),
...
__decorate([
    (0, common_1.Post)('register-claude-code-cli'),
    (0, swagger_1.ApiOperation)({ summary: 'Register Claude Code CLI as local LLM provider' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Claude Code CLI has been successfully registered' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Claude Code CLI not available on this system' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], LLMProviderController.prototype, "registerClaudeCodeCLI", null);
__decorate([
    (0, common_1.Post)('register-gemini-cli'),
    (0, swagger_1.ApiOperation)({ summary: 'Register Gemini CLI as local LLM provider' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Gemini CLI has been successfully registered' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Gemini CLI not available on this system' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
exports.LLMProviderController = LLMProviderController = __decorate([
    ...
    (0, common_1.Controller)('llm/providers'),

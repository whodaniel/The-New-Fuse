...
let MonitoringController = class MonitoringController {
     ...
     */
    constructor() {
        this.memoryTrendBaselines = new Map();
    }
    /**
     ...
     */
    async getAppMetrics() {
        throw new common_1.HttpException('Application-level metrics are not implemented in this deployment.', common_1.HttpStatus.NOT_IMPLEMENTED);
    }
    /**
     ...
     */
    generateHealthSummary(status, alerts) {
        if (status === 'healthy') {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get memory usage and GC statistics' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], MonitoringController.prototype, "getMemory", null);
__decorate([
    (0, common_1.Get)('app-metrics'),
    (0, swagger_1.ApiOperation)({ summary: 'Get application-specific metrics' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], MonitoringController.prototype, "getAppMetrics", null);
__decorate([
    (0, common_1.Get)('health'),
    (0, swagger_1.ApiOperation)({ summary: 'Get system health overview' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)

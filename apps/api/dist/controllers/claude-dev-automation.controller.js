...
exports.ClaudeDevAutomationController = exports.TemplateCustomizationDto = exports.CreateAgentBatchDto = exports.ExecuteTaskDto = exports.ClaudeDevUpdateAgentDto = exports.ClaudeDevCreateAgentDto = void 0;
// @ts-nocheck
...
class ClaudeDevCreateAgentDto {
    constructor() {
        this.template = '';
    }
}
exports.ClaudeDevCreateAgentDto = ClaudeDevCreateAgentDto;
class ClaudeDevUpdateAgentDto {
}
exports.ClaudeDevUpdateAgentDto = ClaudeDevUpdateAgentDto;
class ExecuteTaskDto {
    constructor() {
        this.type = 'code_review';
    }
}
...
let ClaudeDevAutomationController = ClaudeDevAutomationController_1 = class ClaudeDevAutomationController {
    constructor(claudeDevService) {
        ...
        this.logger = new common_1.Logger(ClaudeDevAutomationController_1.name);
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, ClaudeDevCreateAgentDto]),
    __metadata("design:returntype", Promise)

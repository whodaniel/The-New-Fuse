...
var ImplementerAgentService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ImplementerAgentService = void 0;
...
let ImplementerAgentService = ImplementerAgentService_1 = class ImplementerAgentService {
    constructor(drizzle) {
        this.drizzle = drizzle;
        this.logger = new common_1.Logger(ImplementerAgentService_1.name);
        this.codebaseRoot = (0, codebase_root_1.resolveCodebaseRoot)();
    }
    async implementImprovement(task) {
    ...
    generateServiceTemplate(feature) {
...
`;
    ...
    generateControllerTemplate(feature) {
        const className = feature.name.replace(/\s+/g, '');
...
`;
    ...
    async generateFeatureTests(feature) {
        const className = feature.name.replace(/\s+/g, '');
        const serviceName = feature.name.toLowerCase().replace(/\s+/g, '-');
...
`;
    ...
    async createPullRequest(implementation) {
...
exports.ImplementerAgentService = ImplementerAgentService;
exports.ImplementerAgentService = ImplementerAgentService = ImplementerAgentService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [database_1.DrizzleService])
], ImplementerAgentService);
//# sourceMappingURL=implementer.service.js.map
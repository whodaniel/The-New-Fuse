...
exports.SmartAccountModule = SmartAccountModule = __decorate([
    (0, common_1.Module)({
        imports: [web3auth_module_1.Web3authModule, database_1.DatabaseModule],
        controllers: [smart_account_controller_1.SmartAccountController],
        providers: [smart_account_service_1.SmartAccountService],
        exports: [smart_account_service_1.SmartAccountService]
    })
], SmartAccountModule);
//# sourceMappingURL=smart-account.module.js.map
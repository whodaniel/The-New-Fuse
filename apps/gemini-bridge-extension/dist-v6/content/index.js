/******/ (() => {
  ...
  class EnhancedFloatingPanel {
    ...
    renderSettingsTab() {
      ...
      <div class="fcp6-section-title" style="margin-top:16px;">Connection</div>
       <div style="padding: 10px; background: rgba(0,0,0,0.2); border-radius: 8px;">
          ...
          <input type="text" data-setting="relayUrl" value="ws://127.0.0.1:3000/ws" class="fcp6-input" style="width:100%; margin-bottom:8px;">
       </div>
    ...
    saveSettings() {
      ...
      const settings = {
        relayUrl: relayUrl?.value || 'ws://127.0.0.1:3000/ws',

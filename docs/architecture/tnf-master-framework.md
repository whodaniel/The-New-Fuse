...
flowchart LR
  ...
  subgraph Apps[Detected apps/*]
    ...
    app_backend[backend]
    app_browser_control_surfaces[browser-control-surfaces]
  ...
  subgraph Packages[Detected packages/*]
    ...
    pkg_agent[agent]
    pkg_agent_adapters[agent-adapters]
    ...
    pkg_cli[cli]
    pkg_client[client]
    pkg_coding_agent_delegation[coding-agent-delegation]
    pkg_common[common]
    ...
    pkg_workflow_builder[workflow-builder]
  ...
  subgraph Workflows[Detected .github/workflows]
    ...
    wf_close_jules_persona_prs_yml[close-jules-persona-prs.yml]
    wf_deploy_frontend_pages_yml[deploy-frontend-pages.yml]
  ...
  Web -.maps.-> app_browser_control_surfaces
  ...
  Gateway -.depends on.-> pkg_agent_adapters
  ...
  Gateway -.depends on.-> pkg_coding_agent_delegation
  ...
  Gateway -.depends on.-> pkg_llm_catalog
  ...
  Gateway -.depends on.-> pkg_rust_relay
  ...
  Gateway -.depends on.-> pkg_workflow_builder
  ...
  wf_close_jules_persona_prs_yml --> Audits
  wf_deploy_frontend_pages_yml --> Audits

...
- Connects to `owner/tnf` cloud builder
...
Builder name: cloud-owner-tnf
Driver: cloud (owner/tnf)
```
...
**Resulting images:**
- `owner/the-new-fuse-api:latest`
- `owner/the-new-fuse-api:<git-sha>`
...
**Resulting images:**
- `owner/the-new-fuse-frontend:latest`
- `owner/the-new-fuse-frontend:<git-sha>`
...
1. Go to: https://app.docker.com/accounts/owner/cloud/integrations/gha?builder=tnf
...
docker buildx inspect cloud-owner-tnf

# Recreate builder
docker buildx rm cloud-owner-tnf
./docker-buildx-setup.sh
```

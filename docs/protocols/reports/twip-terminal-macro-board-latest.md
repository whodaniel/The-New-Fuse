...
Generated: 2026-09-05T09:50:37.736Z
Tenant: `tnf-local`
...
- Idle terminals: 0
- Active ratio: 1
- Top work executables: node(3), cursor-agent(2), pi(1)
...
- `/dev/ttys002` -> pi | ctx: ~ | ↑208k ↓30k R3.6M CH99.3% 62.1%/128k (auto)              (aihubmix) glm-5.3-flash
...
- `/dev/ttys005` -> cursor-agent | ctx: Auto · 44.8% · 2 files edited                                 Run Everything | ~

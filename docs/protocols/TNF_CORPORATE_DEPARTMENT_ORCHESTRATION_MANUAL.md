...
**Status:** ACTIVE **Scope:** System-Wide Departmental Orchestration
**Location:** /The-New-Fuse/docs/protocols/

This manual expands the TNF Corporate Chain of Command into actionable, distinct
Departments. It defines staffing requirements, job responsibilities,
inbox/outbox handoffs, and long-tail project tracking to ensure all AI agents
and traditional enterprise tools orchestrate together in a logically cohesive
whole.
...
- **Staffing Requirements:** `Librarian Agents`, `Chronology Specialists`,
...
- **Inbox (Receivables):** Raw data from the Scouting Department; Distilled
...
- **Inbox (Receivables):** Notifications from Librarians that new Raw Data is
  ready for distillation; Bug reports from the Governance Department.
...
- **Staffing Requirements:** `Protocol Growth Blocker Auditor`,
  `Staffing Director Agent`, `LLM API Runner`.
- **Job Responsibilities:**
...
- **Staffing Requirements:** `Journaling Agents`, `Reviewer Agents`,

...
This ledger tracks the current status of all agents in the TNF system. It is
updated automatically by the agent status reporting mechanism.

## Current Entries

- **tnf-cli-agent** – Available, dispatchable

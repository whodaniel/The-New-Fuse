...
### Purpose
Runs comprehensive test suite including linting, type checking, unit tests, integration tests, and E2E tests.
...
### Purpose
Builds all packages and applications, verifies artifacts, and tests production builds.
...
### Purpose
Enforces quality standards for code coverage, bundle size, performance, and security.

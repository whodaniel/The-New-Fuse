...
**Last Updated:** November 18, 2025 **Frontend Status:** ✅ Live at
thenewfuse.com **Router:** ComprehensiveRouter.tsx
...
| `/chat?mode=workspace` | Workspace Chat (canonical)          | chat/ChatHub.tsx                 |
| `/workspace-chat`      | Redirects to `/chat?mode=workspace` | Redirects to ChatHub             |
| `/workspace/chat`      | Redirects to `/chat?mode=workspace` | Redirects to ChatHub             |
...
**Generated by:** Claude Code **Source:**

...
install from tagged `The-New-Fuse` release passes end-to-end.
...
| ------------------------------- | ------------ | ------------------------------------------------------------------- |
| **Open Source**                 | ✅ Pass      | `github.com/whodaniel/The-New-Fuse` public; MIT LICENSE live   |
...
| **Star on GitHub**              | ✅ **Fixed** | All CTAs → `The-New-Fuse`                                      |
...
| github.com/whodaniel/The-New-Fuse | 200               |
| github.com/whodaniel/The-New-Fuse              | **404** (private) |
...
| #   | Risk                       | Status   | Notes                                          |
| --- | -------------------------- | -------- | ---------------------------------------------- |
| 1   | GitHub links → profile     | ✅ Fixed | All → `The-New-Fuse`                      |
...
curl -sL https://thenewfuse.com | grep -oE 'The-New-Fuse|Free During Beta|113|100ms|\$30' | sort -u
...
1. Commit + sync monorepo fixes → `The-New-Fuse`

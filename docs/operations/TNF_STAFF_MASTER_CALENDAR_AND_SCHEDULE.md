...
Generated: 2026-08-26T03:15:01.983Z
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tnf-swarm-stress-test | system_framework | self_improvement_core | tnf-swarm-supervisor | */10 * * * * | UTC | yes | deferred | open | scripts/orchestrator/swarm-stress-test.sh |
...
| tnf-master-clock-super-cycle | system_framework | orchestration_gate | master-clock | */15 * * * * | UTC | yes | error | locked | scripts/protocols/synthetic-federation-gate-check.cjs |
| tnf-openclaw-runtime-sync | system_framework | observability | master-clock | */15 * * * * | UTC | yes | healthy | open | scripts/openclaw/tnf-openclaw-control.cjs |
...
| tnf-llm-verified-fleet-cycle | system_framework | self_improvement_core | tnf-llm-intel-optimizer | 0 */6 * * * | UTC | yes | error | open | scripts/llm-intel/tnf-llm-verified-fleet-cycle.cjs |
...
- tnf-master-clock-super-cycle: runtime-error (enabled=true, lock=true, runtime=error)
- tnf-terminal-awareness-reminder: runtime-error (enabled=true, lock=false, runtime=error)
- tnf-llm-verified-fleet-cycle: runtime-error (enabled=true, lock=false, runtime=error)

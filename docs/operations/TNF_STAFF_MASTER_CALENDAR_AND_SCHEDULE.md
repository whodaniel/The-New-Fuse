...
Generated: 2026-08-13T11:15:02.493Z
...
| tenant-loop-watchdog                           | tenant           | tenant_agent_loop         | auth-blocker-sentinel                            | _/15 _ \* \* \* | UTC              | yes     | running | open   | scripts/protocols/chronological-dispatch.cjs                                |
...
| tenant-continuous-qa-loop                      | tenant           | tenant_automation         | qa-swarm-supervisor                              | 0 _/6 _ \* \*   | UTC              | yes     | running | open   | scripts/protocols/chronological-dispatch.cjs                                |
...
| tenant-knowledge-scout-sprint                  | tenant           | tenant_automation         | information-retrieval-agent                      | 0 _/4 _ \* \*   | UTC              | yes     | unknown | open   | scripts/swarm/knowledge-scout-complete.cjs                                  |
| tenant-personal-archaeology-digest             | tenant           | tenant_automation         | personal-archaeology-narrative-team-orchestrator | 0 _/12 _ \* \*  | UTC              | yes     | unknown | open   | scripts/timeline/personal-archaeology-orchestrator.mjs                      |
...
| tnf-growth-blocker-audit                       | system_framework | self_improvement_core     | tnf-growth-blocker-auditor                       | 0 _/4 _ \* \*   | UTC              | yes     | unknown | open   | .skills/tnf-growth-blocker-auditor/scripts/run_growth_blocker_audit.cjs     |
| tnf-llm-arena-intel-collector                  | system_framework | observability             | tnf-llm-intel-collector                          | 0 _/4 _ \* \*   | UTC              | yes     | unknown | open   | scripts/llm-intel/llm-arena-intel-collector.cjs                             |
...
| tnf-runtime-log-rotation                       | system_framework | observability             | master-clock                                     | 0 _/4 _ \* \*   | UTC              | yes     | unknown | open   | scripts/protocols/rotate-runtime-logs.cjs                                   |
...
| tnf-staffing-director-cycle                    | system_framework | staff_architecture        | tnf-staffing-director-agent                      | 30 _/6 _ \* \*  | UTC              | yes     | unknown | open   | .skills/tnf-staffing-director-agent/scripts/run_staffing_director_cycle.cjs |
...
| tnf-llm-ranking-optimizer                      | system_framework | self_improvement_core     | tnf-llm-intel-optimizer                          | 30 _/4 _ \* \*  | UTC              | yes     | unknown | open   | scripts/llm-intel/llm-ranking-optimizer.cjs                                 |
...
- tnf-terminal-awareness-reminder: runtime-error (enabled=true, lock=false,
  runtime=error)
- tenant-continuous-qa-loop: stale-run-window (enabled=true, lock=false,
  runtime=running)
- tenant-knowledge-scout-sprint: stale-run-window (enabled=true, lock=false,
  runtime=unknown)
- tnf-growth-blocker-audit: stale-run-window (enabled=true, lock=false,
  runtime=unknown)
- tnf-llm-arena-intel-collector: stale-run-window (enabled=true, lock=false,
  runtime=unknown)
- tnf-llm-verified-fleet-cycle: stale-run-window (enabled=true, lock=false,
  runtime=healthy)
- tnf-runtime-log-rotation: stale-run-window (enabled=true, lock=false,
  runtime=unknown)
- tnf-self-improvement-scorecard: stale-run-window (enabled=true, lock=true,
  runtime=healthy)

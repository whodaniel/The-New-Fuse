...
Generated: 2026-08-31T02:19:03.603Z

## Summary

- Total schedules: 23
- Enabled schedules: 23
- Disabled schedules: 0
- Locked schedules: 2
- Schedules with stale-run warning: 0
- Interrelationship edges: 40
...
| tnf-recursive-logic-sieve          | system_framework | self_improvement_core     | tnf-swarm-supervisor            | _/15 _ \* \* \* | UTC | yes     | healthy | open   | scripts/autonomy/tnf-recursive-logic-sieve.sh                           |
...
| tenant-knowledge-scout-sprint      | system_framework | scouting                  | tnf-cli-agent                   | 0 _/4 _ \* \*   | UTC | yes     | healthy | open   | scripts/swarm/knowledge-scout-complete.cjs                              |
...
| tnf-growth-blocker-audit           | system_framework | self_improvement_core     | tnf-growth-blocker-auditor      | 0 _/4 _ \* \*   | UTC | yes     | error   | open   | .skills/tnf-growth-blocker-auditor/scripts/run_growth_blocker_audit.cjs |
...
| tnf-swarm-role-call-and-scheduling | system_framework | swarm_coordination        | tnf-swarm-scheduling-agent      | _/20 _ \* \* \* | UTC | yes     | error   | open   | scripts/protocols/swarmops-role-call.cjs                                |
...
| tnf-tmux-reap                      | system_framework | system_terminal_awareness | tnf-master-clock                | 15 \* \* \* \*  | UTC | yes     | healthy | open   | scripts/runtime/tnf-tmux.cjs                                            |
...
- [shared-owner] tnf-terminal-heartbeat-pulse -> tnf-tmux-reap (Shared owner:
  tnf-master-clock)
...
- [shared-category] tnf-terminal-awareness-reminder -> tnf-tmux-reap (Shared
  category: system_terminal_awareness)
- [shared-category] tnf-terminal-heartbeat-pulse -> tnf-tmux-reap (Shared
  category: system_terminal_awareness)
...
- tnf-terminal-awareness-reminder: runtime-error (enabled=true, lock=false,
  runtime=error)
- tnf-growth-blocker-audit: runtime-error (enabled=true, lock=false,
  runtime=error)
- tnf-self-improvement-scorecard: system-lock-review (enabled=true, lock=true,
  runtime=healthy)
- tnf-swarm-role-call-and-scheduling: runtime-error (enabled=true, lock=false,
  runtime=error)
